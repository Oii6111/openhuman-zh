 ...
 * https://docs.composio.dev/toolkits/managed-auth plus 小鹈鹕's
...
function GenericIntegrationIcon() {
  return (
    <span className="flex h-8 w-8 items-center justify-center rounded-xl bg-surface-subtle text-content-secondary shadow-xs ring-1 ring-black/5">
...
function ComposioLogoBadge({
  ...
  return (
    <span className="flex h-8 w-8 items-center justify-center overflow-hidden rounded-xl bg-surface shadow-xs ring-1 ring-black/5">
      <img
        src={logoUrl}
        alt={`${name} logo`}
 ...
 * and that repository's `mapComposioCategory keeps the buckets its 小鹈鹕
