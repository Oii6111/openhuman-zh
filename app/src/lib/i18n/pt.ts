...
const messages: TranslationMap = {
  ...
  'share.defaultHeadline': 'Veja o que o meu agente 小鹈鹕 acabou de fazer',
  'share.defaultAgentName': 'O meu agente',
  'share.defaultCaption': 'Veja o que o meu agente 小鹈鹕 acabou de fazer.',
  'share.captionWithHeadline': '{headline}. Feito com o meu agente 小鹈鹕.',
  ...
  'feedback.welcome.body':
    'Diga-nos o que funciona, o que falta e o que tornaria o 小鹈鹕 melhor. Publique uma ideia, vote nas sugestões dos outros e veja as melhores subirem ao topo do nosso roteiro.',
  ...
  'rewards.welcome.body':
    'Ganhe pontos à medida que usa o 小鹈鹕 e convida outros, mantenha a sua sequência viva e resgate o que ganhou, tudo registado num só lugar.',
  ...
  'settings.core.applyRestartNote': 'Salvar reinicia o 小鹈鹕 para reconectar.',
  ...
  'conversations.toolFailure.missingPermission.cause':
    'O 小鹈鹕 ainda não tem permissão para fazer isso.',
  ...
  'conversations.toolFailure.serviceUnavailable.cause':
    'Um serviço de que o 小鹈鹕 precisa está temporariamente indisponível.',
  'conversations.toolFailure.serviceUnavailable.next':
    'O 小鹈鹕 tentará de novo em breve: nenhuma ação necessária.',
  ...
  'conversations.toolFailure.modelConnection.cause':
    'O 小鹈鹕 não conseguiu acessar o modelo de IA.',
  'conversations.toolFailure.modelConnection.next':
    'Verifique sua conexão ou as configurações do modelo; o 小鹈鹕 tentará novamente.',
  'conversations.toolFailure.timeout.cause': 'A ação demorou demais e foi interrompida.',
  'conversations.toolFailure.timeout.next':
    'O 小鹈鹕 tentará novamente, ou você pode tentar manualmente.',
  ...
  'conversations.toolFailure.approvalExpired.next':
    'Peça novamente para executá-la: o 小鹈鹕 não tentará de novo sozinho.',
  ...
  'orchPage.medulla.tagline': 'O modelo de orquestração da 小鹈鹕',
  'orchPage.medulla.body':
    'O Medulla é o LLM próprio da 小鹈鹕, projetado para orquestrar milhares de agentes de uma só vez, com uma janela de contexto de 10 milhões de tokens e uma orquestração de custo radicalmente baixo.',
  ...
  'orchPage.medulla.subscriberTitle': 'Assinantes da 小鹈鹕',
  'orchPage.medulla.subscriberNote':
    'Quando o Medulla for lançado, será exclusivo para assinantes da 小鹈鹕.',
  ...
  'orchPage.connections.initDesc':
    'Crie um novo subagente para trabalhar ao seu lado. Abra o chat do agente e descreva o papel, o objetivo e as ferramentas: o 小鹈鹕 provisiona uma instância dedicada que você controla daqui.',
  ...
  'tinyplaceOrchestration.master.preview': 'Coordenação direta entre você e o 小鹈鹕.',
  ...
  'tinyplaceOrchestration.composer.placeholder': 'Mensagem para o 小鹈鹕…',
  ...
  'welcome.logoAlt': '小鹈鹕',
  'welcome.title': 'Bem-vindo ao 小鹈鹕',
  'welcome.subtitle':
  ...
  'welcome.resetErrorFallback':
    'Não foi possível limpar os dados do app. Por favor, feche e reabra o 小鹈鹕 e tente novamente.',
  ...
  'home.statusCoreUnreachable':
    'O processo em segundo plano do 小鹈鹕 não está respondendo. Ele pode ter travado ou falhado ao iniciar.',
  ...
  'rewards.localUnavailable':
    'O login local não rende recompensas, cupons nem crédito de indicação. Saia e continue entrando com uma conta 小鹈鹕 se quiser que as recompensas contem.',
  ...
  'onboarding.welcome': 'Olá. Eu sou o 小鹈鹕.',
  ...
  'onboarding.finishDesc': 'Tudo pronto! Comece a usar o 小鹈鹕.',
  'onboarding.skip': 'Pular',
  'onboarding.getStarted': 'Começar',
  'onboarding.runtimeChoice.title': 'Como você gostaria de rodar o 小鹈鹕?',
  ...
  'onboarding.runtimeChoice.cloud.tagline': 'Deixe o 小鹈鹕 gerenciar tudo para você.',
  ...
  'onboarding.custom.defaultSubtitle': 'Deixe o 小鹈鹕 gerenciar para você.',
  ...
  'onboarding.custom.inference.defaultDesc':
    'O 小鹈鹕 direciona cada carga de trabalho para um modelo padrão adequado. Sem chaves, sem configuração.',
  ...
  'onboarding.custom.voice.defaultDesc':
    'O 小鹈鹕 vem com STT/TTS gerenciado que funciona sem configuração.',
  ...
  'onboarding.custom.oauth.defaultDesc':
    'O 小鹈鹕 usa um espaço de trabalho Composio gerenciado. Um clique para conectar cada serviço depois.',
  ...
  'onboarding.custom.search.subtitle': 'Como o 小鹈鹕 pesquisa na web em seu nome.',
  'onboarding.custom.search.defaultDesc':
    'O 小鹈鹕 usa um backend de pesquisa gerenciado. Sem chaves necessárias.',
  ...
  'onboarding.custom.embeddings.subtitle':
    'Como o 小鹈鹕 gera embeddings vetoriais para busca semântica na memória.',
  'onboarding.custom.embeddings.defaultDesc':
    'O 小鹈鹕 usa um serviço gerenciado de embeddings. Nenhuma chave de API necessária.',
  ...
  'onboarding.custom.memory.subtitle':
    'Como o 小鹈鹕 se lembra do seu contexto, preferências e conversas anteriores.',
  'onboarding.custom.memory.defaultDesc':
    'O 小鹈鹕 gerencia o armazenamento e a recuperação de memória automaticamente. Sem nada para configurar.',
  ...
  'misc.beta':
    'O 小鹈鹕 está em beta inicial. Sinta-se à vontade para compartilhar feedback ou reportar bugs que encontrar: cada relato nos ajuda a melhorar mais rápido.',
  ...
  'privacy.shareAnonymizedDataDesc':
    'Ajude a melhorar o 小鹈鹕 compartilhando relatórios de falhas e eventos de uso com privacidade limitada, incluindo um ID de conta estável e metadados da versão do app. Mensagens, chaves de carteira, chaves de API e tokens de sessão nunca são coletados.',
  ...
  'privacy.autoHandoffMeetDesc':
    'Quando uma chamada do Google Meet termina, o orquestrador do 小鹈鹕 pode ler a transcrição e pode realizar ações como redigir mensagens, agendar acompanhamentos ou postar resumos no seu espaço de trabalho Slack conectado. Desativado por padrão.',
  ...
  'settings.about.starCta.title': 'Gostando do 小鹈鹕?',
  ...
  'settings.search.menuDesc':
    'Padrão para pesquisa gerenciada por 小鹈鹕 ou conecte seu próprio provedor com uma chave API.',
  'settings.search.description':
    'Escolha o mecanismo de busca usado pelo agente, ou desative as ferramentas de pesquisa completamente. Gerenciado usa o backend do 小鹈鹕 (sem configuração). Parallel, Brave, Querit e Exa funcionam diretamente do seu computador usando sua chave de API.',
  ...
  'settings.search.engineManagedLabel': '小鹈鹕 Gerenciado',
  'settings.search.engineManagedDesc':
    'Padrão. Roteado através do backend do 小鹈鹕, atualmente com tecnologia Exa: nenhuma chave API é necessária.',
  'settings.search.localManagedUnavailable':
    'A busca gerenciada pela 小鹈鹕 não está disponível para usuários locais. Adicione sua própria chave de API do Parallel, Brave, Querit ou Exa para habilitar a busca na web.',
  ...
  'settings.embeddings.requiresSignIn': 'Requer login no 小鹈鹕',
  'settings.embeddings.managedLoginRequired':
    'Embeddings gerenciados requerem login no 小鹈鹕. Faça login para usar o backend do 小鹈鹕.',
  'settings.embeddings.managedBannerIntro':
    'Embeddings gerenciados passam pelo backend do 小鹈鹕 e exigem uma sessão de conta 小鹈鹕.',
  ...
  'settings.embeddings.managedBannerRemoteSession':
    'Faça login novamente para atualizar sua sessão 小鹈鹕, ou mude para um provedor de embeddings local ou com sua própria chave.',
  ...
  'devices.betaText':
    'Este recurso está atualmente em beta. Vincule iPhones a este 小鹈鹕 para usá-los como cliente remoto.',
  ...
  'devices.emptyState':
    'Escaneie um QR code no seu iPhone para conectá-lo a esta sessão do 小鹈鹕.',
  ...
  'devices.pairModal.instructions': 'Abra o app 小鹈鹕 no seu iPhone e escaneie este código.',
  ...
  'mcp.connectAuth.oauthHint':
    'Este servidor usa OAuth. Entre pelo seu navegador para autorizar o 小鹈鹕.',
  ...
  'autonomy.maxActionsHelp':
    'Número máximo de ações de ferramentas que um agente pode executar por hora corrida. O novo valor se aplica ao próximo chat. Cron jobs e ouvintes de canais mantêm o limite atual até você reiniciar o 小鹈鹕.',
  ...
  'settings.tools.chooseCapabilities':
    'Escolha quais funcionalidades o 小鹈鹕 pode usar em seu nome.',
  ...
  'voice.providers.chip.cloud': '小鹈鹕 (Gerenciado)',
  'voice.providers.chip.cloudAria': 'O provedor gerenciado 小鹈鹕 está sempre ativado',
  ...
  'pttSettings.description':
    'Mantenha uma tecla pressionada para falar com o 小鹈鹕 enquanto está noutro aplicativo. Soltar a tecla envia o áudio; se «Ler respostas em voz alta» estiver ativo, o 小鹈鹕 lê a resposta.',
  ...
  'pttSettings.errorAccessibility':
    'O macOS precisa de permissão de Acessibilidade para este atalho. Abra Ajustes do Sistema → Privacidade e Segurança → Acessibilidade e ative o 小鹈鹕.',
  ...
  'pttSettings.errorUnsupportedWayland':
    'As sessões Wayland ainda não suportam atalhos globais no 小鹈鹕: mude para uma sessão X11 ou use o controlo de ditado integrado no aplicativo.',
  ...
  'chat.attachment.videoNotSupported':
    'Este modelo não consegue ler vídeos. Você pode usar o nível Raciocínio do 小鹈鹕 para anexar seu vídeo.',
  ...
  'chat.attachment.imageNotSupported':
    'Este modelo não consegue ler imagens. Você pode usar o nível Raciocínio do 小鹈鹕 para anexar sua imagem.',
  ...
  'bootCheck.desktopDescription':
    'O 小鹈鹕 precisa de um runtime para pensar. Escolha onde ele deve ficar.',
  'bootCheck.webDescription':
    'Na web, o 小鹈鹕 conecta-se a um runtime que você controla. Insira o URL e o token de autenticação abaixo, ou baixe o app desktop para rodar um na sua máquina.',
  ...
  'bootCheck.legacyDescription':
    'Um daemon 小鹈鹕 instalado separadamente já está rodando neste dispositivo. Precisamos removê-lo antes que o runtime integrado possa assumir.',
  ...
  'bootCheck.portConflictBody':
    'Outro processo está usando a porta de rede que o 小鹈鹕 precisa. Tentaremos corrigir isso automaticamente.',
  ...
  'bootCheck.portConflictOwner':
    '{name} (PID {pid}) está usando a porta de rede que o 小鹈鹕 precisa.',
  ...
  'welcome.gatewaySessionErrorFallback':
    'Não foi possível concluir o login neste momento. O armazenamento de sessão não respondeu a tempo (mesmo após tentar novamente). Reinicie o 小鹈鹕 e tente de novo.',
  ...
  'composio.expiredDescription':
    'Reconecte para reativar as ferramentas {name}. 小鹈鹕 manterá esta integração indisponível até que você atualize o acesso de OAuth.',
  ...
  'mic.voiceNotCompiled':
    'A transcrição de voz não está incluída nesta versão do aplicativo. Atualize o 小鹈鹕 para ativá-la.',
  ...
  'app.connectionIndicator.connected': 'Conectado ao 小鹈鹕 AI 🚀',
  ...
  'app.openhumanLink.notifications.permissionOff':
    'A permissão de notificações está desativada. Ative o 小鹈鹕 em Configurações do sistema → Notificações e tente novamente.',
  'app.openhumanLink.notifications.triggerFailed':
    'O 小鹈鹕 não conseguiu disparar uma notificação do sistema. Verifique as configurações de notificação do sistema operacional e tente novamente.',
  'app.openhumanLink.notifications.welcomeBody':
    'Você receberá avisos aqui quando algo precisar da sua atenção.',
  'app.openhumanLink.notifications.welcomeTitle': 'O 小鹈鹕 está pronto',
  ...
  'app.openhumanLink.notifications.sent':
    'Notificação de teste enviada. Se você não a recebeu, vá em Configurações do Sistema → Notificações → 小鹈鹕, ative Permitir Notificações e defina o Estilo de Banner como Persistente.',
  ...
  'channels.authMode.managed_dm': 'Faça login com 小鹈鹕',
  ...
  'channels.discord.authMode.oauth.description':
    'Instale o bot 小鹈鹕 em seu servidor Discord via OAuth.',
  'channels.discord.authMode.managed_dm.description':
    'Vincule sua conta pessoal Discord ao bot 小鹈鹕.',
  ...
  'channels.telegram.authMode.managed_dm.description':
    'Envie uma mensagem diretamente para o bot 小鹈鹕 Telegram.',
  ...
  'channels.connectHelp.discord':
    'Escolha um método abaixo: vincule sua conta pelo 小鹈鹕, instale o bot com OAuth ou cole seu próprio token de bot do portal de desenvolvedores do Discord.',
  'channels.connectHelp.telegram':
    'Escolha um método abaixo: envie uma mensagem ao bot gerenciado do 小鹈鹕 para vincular sua conta, ou cole seu próprio token de bot do @BotFather.',
  ...
  'iosPair.error.invalidQr':
    'QR code inválido. Certifique-se de estar escaneando um código de pareamento do 小鹈鹕.',
  ...
  'iosPair.instructions':
    'Abra o 小鹈鹕 no seu desktop, vá em Configurações > Dispositivos e toque em "Parear telefone" para exibir o QR code.',
  'iosPair.retryScan': 'Repetir verificação',
  'iosPair.scanQrCode': 'Digitalizar QR code',
  'iosPair.scannerOpening': 'Scanner abrindo...',
  'iosPair.step.openDesktop': 'Abra 小鹈鹕 na área de trabalho',
  ...
  'composio.connect.permissionsNoteSuffix':
    'As permissões do agente do 小鹈鹕 são controladas abaixo como botões de leitura, escrita e admin.',
  ...
  'composio.triggers.sessionExpired':
    'Sua sessão do 小鹈鹕 expirou. Entre novamente para carregar os gatilhos.',
  ...
  'daemon.serviceBlockingGate.title': 'O core do 小鹈鹕 está indisponível',
  ...
  'intelligence.diagram.imageAlt': 'Último diagrama de arquitetura 小鹈鹕 gerado',
  ...
  'flows.nodeSummary.toolCall.pickNative': 'Executa uma ferramenta do 小鹈鹕 (escolha uma)',
  ...
  'rewards.community.activityStreakHint':
    'Dias consecutivos em que você esteve ativo no 小鹈鹕.',
  ...
  'rewards.community.roleClaimDesc':
    'Você desbloqueou cargos do Discord, mas ainda não entrou no servidor do 小鹈鹕. Entre para que sejam atribuídos automaticamente.',
  ...
  'settings.ai.providers.managedDetail': 'O 小鹈鹕 escolhe um modelo para cada tarefa',
  ...
  'settings.ai.openhumanDefault': '小鹈鹕 (padrão)',
  ...
  'settings.ai.managedSourceLabel': 'Gerenciado pela 小鹈鹕',
  ...
  'settings.ai.routing.managedDesc':
    '小鹈鹕 executará toda a inferência na nuvem, escolherá o melhor modelo para a tarefa, otimizará os custos e manterá os padrões de roteamento mais seguros.',
  'settings.ai.routing.managedMsg':
    '小鹈鹕 irá gerenciar toda a inferência para cada carga de trabalho e escolherá automaticamente a melhor rota em termos de custo, qualidade e segurança.',
  ...
  'settings.composio.confirmWarning':
    'Suas integrações existentes (Gmail, Slack, GitHub, etc. conectadas via 小鹈鹕) não ficarão visíveis: elas vivem no tenant do Composio gerenciado pelo 小鹈鹕.',
  ...
  'settings.composio.modeManaged': 'Gerenciado (小鹈鹕 cuida para você)',
  'settings.composio.modeManagedDesc':
    'O 小鹈鹕 faz proxy das chamadas de ferramentas pelo nosso backend (recomendado). A autenticação é intermediada; você nunca cola uma chave de API do Composio. Webhooks são totalmente roteados.',
  ...
  'settings.developerMenu.tools.desc':
    'Ative ou desative capacidades que o 小鹈鹕 pode usar em seu nome',
  ...
  'settings.developerMenu.mcpServer.desc':
    'Configurar clientes MCP externos para se conectarem a 小鹈鹕',
  ...
  'settings.mcpServer.binaryPathNotFound':
    '小鹈鹕 binário não encontrado. Se estiver executando a partir do código-fonte, crie com: cargo build --bin openhuman-core',
  ...
  'settings.agentAccess.tinyplaceAutopilot.desc':
    'Deixe o 小鹈鹕 agir sozinho no tiny.place. De forma agendada, ele busca trabalhos relevantes (priorizando recompensas abertas), executa o que combina com suas habilidades e age com a sua identidade. Funciona sem supervisão e pode gastar, então mantenha-o na devnet durante os testes. Desativado por padrão.',
  ...
  'settings.mascot.colorAria': '小鹈鹕 cor',
  ...
  'settings.mascot.libraryUnavailable': '小鹈鹕 biblioteca indisponível',
  'settings.mascot.title': '小鹈鹕',
  'settings.mascot.loadingLibrary': 'Carregando biblioteca do 小鹈鹕…',
  ...
  'settings.mascot.localDefault': '小鹈鹕 local (padrão)',
  'settings.mascot.menuTitle': 'Mascote',
  'settings.mascot.menuDesc': 'Escolha a cor do mascote usada em todo o app',
  'settings.mascot.noCharacters': 'Nenhum personagem do 小鹈鹕 disponível ainda',
  ...
  'settings.memoryWindow.description':
    'A quantidade de contexto que o 小鹈鹕 injeta em cada nova execução do agente. Janelas maiores parecem mais cientes de conversas passadas, mas usam mais tokens e custam mais a cada execução.',
  ...
  'skills.meetingBots.couldNotStartTitle': 'Não foi possível iniciar o 小鹈鹕',
  'skills.meetingBots.displayName': 'Nome de exibição',
  'skills.meetingBots.failedToStart': 'Falha ao iniciar o 小鹈鹕.',
  'skills.meetingBots.joiningMessage': 'Ele deve aparecer como participante em alguns segundos.',
  'skills.meetingBots.joiningTitle': '小鹈鹕 está entrando na reunião',
  'skills.meetingBots.meetingLink': 'Link da reunião',
  'skills.meetingBots.modalAriaLabel': 'Enviar 小鹈鹕 para uma reunião',
  'skills.meetingBots.modalDesc': 'Descrição do modal',
  'skills.meetingBots.modalTitle': 'Enviar 小鹈鹕 para uma reunião',
  ...
  'skills.meetingBots.serverOverloaded':
    'O 小鹈鹕 está sob carga intensa no momento. Tente novamente em alguns minutos.',
  ...
  'skills.meetingBots.history.runWith小鹈鹕': 'Executar com 小鹈鹕',
  ...
  'skills.meetingBots.defaults.watchCalendarDesc':
    'Permita que o 小鹈鹕 monitore seu calendário conectado para entrar automaticamente em reuniões ou solicitar confirmação com base nas políticas abaixo. Isso é separado das notificações de lembrete de reunião.',
  ...
  'walkthrough.steps.brainTab.content':
    'Brain é o grafo de memória: o lugar para ver o que o 小鹈鹕 sabe e como as ideias se conectam.',
  ...
  'settings.mascot.noCharactersAvailable': 'Nenhum personagem do 小鹈鹕 disponível ainda',
  ...
  'devOptions.menuToolsDesc':
    'Habilitar ou desabilitar recursos que 小鹈鹕 pode usar em seu nome',
  ...
  'harnessInit.subtitle':
    'O 小鹈鹕 está preparando os componentes necessários na primeira inicialização.',
  ...
  'harnessInit.failedMessage':
    'Algumas etapas de configuração não foram concluídas. Você pode tentar novamente ou continuar: o 小鹈鹕 usará uma alternativa integrada.',
  ...
  'harnessInit.backgroundHint': 'Você pode continuar usando o 小鹈鹕 enquanto isso termina.',

  'keyring.consent.title': 'Armazenamento seguro indisponível',
  'keyring.consent.description':
    'O chaveiro do sistema operacional não está acessível. O 小鹈鹕 precisa da sua permissão para armazenar segredos usando armazenamento local criptografado.',
  ...
  'memory.health.remediation.auth_missing':
    'Nenhuma credencial de embeddings encontrada. Faça login no 小鹈鹕 ou configure embeddings locais do Ollama em Conexões → Chaves de API → Incorporações.',
  ...
  'memory.health.remediation.storage_unavailable':
    'O 小鹈鹕 não consegue gravar no seu armazenamento de memória: o disco ou cartão SD parece estar com falha, cheio ou somente leitura. Verifique a unidade e libere espaço; o processamento da memória será retomado automaticamente assim que o armazenamento voltar a permitir gravação.',
  ...
  'onboarding.custom.vault.defaultDesc':
    'Use os padrões de memória gerenciados pelo 小鹈鹕. O caminho do vault e a integridade da sincronização ainda podem ser revisados depois.',
  ...
  'onboarding.custom.vault.localDisabledReason':
    'A configuração gerenciada requer login no 小鹈鹕 e não está disponível no modo local.',
  ...
  'vaultHealth.writableLabel': 'O vault pode ser gravado pelo 小鹈鹕',
  'vaultHealth.writableRecovery':
    'O 小鹈鹕 ainda não consegue gravar neste vault. Conceda permissões de escrita e atualize.',
  ...
  'memoryData.workspaceVaultDesc':
    'O 小鹈鹕 grava as notas de memória geradas em memory_tree/content.',
  ...
  'memoryData.internalFilesDesc':
    'Índices, estado da fila e resumos são gerenciados pelo 小鹈鹕 para manter a recuperação e a sincronização saudáveis.',
  ...
  'settings.gateway.description':
    'O núcleo pode ser executado localmente, em um contêiner ou em outra máquina por SSH. Você também pode se conectar a um núcleo remoto por meio de uma URL. O 小鹈鹕 gerencia o ciclo de vida das localizações que ele provisiona; para uma URL remota, ele apenas estabelece a conexão.',
