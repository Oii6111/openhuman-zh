...
const messages: TranslationMap = {
  ...
  'share.defaultHeadline': 'Guarda cosa ha appena fatto il mio agente 小鹈鹕',
  'share.defaultAgentName': 'Il mio agente',
  'share.defaultCaption': 'Guarda cosa ha appena fatto il mio agente 小鹈鹕.',
  'share.captionWithHeadline': '{headline}. Realizzato con il mio agente 小鹈鹕.',
  ...
  'feedback.welcome.body':
    'Dicci cosa funziona, cosa manca e cosa renderebbe 小鹈鹕 migliore. Pubblica un’idea, vota le proposte degli altri e guarda le migliori salire in cima alla nostra roadmap.',
  ...
  'rewards.welcome.body':
    'Guadagna punti usando 小鹈鹕 e invitando altri, mantieni viva la tua serie e riscatta ciò che hai guadagnato, tutto tracciato in un unico posto.',
  ...
  'settings.core.applyRestartNote': 'Il salvataggio riavvia 小鹈鹕 per riconnettersi.',
  ...
  'conversations.toolFailure.missingPermission.cause':
    '小鹈鹕 non ha ancora il permesso di farlo.',
  ...
  'conversations.toolFailure.serviceUnavailable.cause':
    'Un servizio necessario a 小鹈鹕 è temporaneamente non disponibile.',
  'conversations.toolFailure.serviceUnavailable.next':
    '小鹈鹕 riproverà a breve: non serve fare nulla.',
  ...
  'conversations.toolFailure.modelConnection.cause':
    '小鹈鹕 non è riuscito a raggiungere il modello di IA.',
  'conversations.toolFailure.modelConnection.next':
    'Controlla la connessione o le impostazioni del modello; 小鹈鹕 riproverà.',
  ...
  'conversations.toolFailure.timeout.next':
    '小鹈鹕 riproverà, oppure puoi riprovare manualmente.',
  ...
  'conversations.toolFailure.approvalExpired.next':
    'Richiedila di nuovo per eseguirla: 小鹈鹕 non riproverà da solo.',
  ...
  'orchPage.medulla.tagline': 'Il modello di orchestrazione di 小鹈鹕',
  'orchPage.medulla.body':
    "Medulla è l'LLM sviluppato internamente da 小鹈鹕, progettato per orchestrare migliaia di agenti in una sola volta, con una finestra di contesto da 10 milioni di token e un'orchestrazione a costi radicalmente ridotti.",
  ...
  'orchPage.medulla.subscriberTitle': 'Abbonati 小鹈鹕',
  'orchPage.medulla.subscriberNote':
    'Quando Medulla sarà disponibile, sarà esclusiva per gli abbonati 小鹈鹕.',
  ...
  'orchPage.connections.initDesc':
    "Avvia un nuovo sotto-agente che lavori al tuo fianco. Apri la chat dell'agente e descrivi ruolo, obiettivo e strumenti: 小鹈鹕 fornisce un'istanza dedicata che puoi guidare da qui.",
  ...
  'tinyplaceOrchestration.master.preview': 'Coordinamento diretto tra te e 小鹈鹕.',
  ...
  'tinyplaceOrchestration.composer.placeholder': 'Messaggio a 小鹈鹕…',
  ...
  'welcome.logoAlt': '小鹈鹕',
  'welcome.title': 'Benvenuto in 小鹈鹕',
  'welcome.subtitle':
  ...
  'welcome.resetErrorFallback':
    "Impossibile cancellare i dati dell'app. Chiudi e riapri 小鹈鹕, poi riprova.",
  ...
  'home.statusCoreUnreachable':
    'Il sidecar core locale non risponde. Il processo in background di 小鹈鹕 potrebbe essersi bloccato o non essere partito.',
  ...
  'rewards.localUnavailable':
    "L'accesso locale non guadagna ricompense, coupon o credito referral. Esci e continua accedendo con un account 小鹈鹕 se vuoi che le ricompense vengano conteggiate.",
  ...
  'onboarding.welcome': 'Ciao. Sono 小鹈鹕.',
  ...
  'onboarding.finishDesc': 'Tutto pronto! Inizia a usare 小鹈鹕.',
  'onboarding.skip': 'Salta',
  'onboarding.getStarted': 'Inizia',
  'onboarding.runtimeChoice.title': 'Come vuoi eseguire 小鹈鹕?',
  ...
  'onboarding.runtimeChoice.cloud.tagline': 'Lascia che 小鹈鹕 gestisca tutto per te.',
  ...
  'onboarding.custom.defaultSubtitle': 'Lascia che 小鹈鹕 lo gestisca per te.',
  ...
  'onboarding.custom.inference.defaultDesc':
    '小鹈鹕 instrada ogni carico di lavoro a un modello predefinito sensato. Niente chiavi, niente configurazione.',
  ...
  'onboarding.custom.voice.defaultDesc':
    '小鹈鹕 include STT/TTS gestiti che funzionano subito. Niente da configurare.',
  ...
  'onboarding.custom.oauth.defaultDesc':
    '小鹈鹕 gestisce un workspace Composio gestito. Un clic per connettere ogni servizio in seguito.',
  ...
  'onboarding.custom.search.subtitle': 'Come 小鹈鹕 cerca sul web per tuo conto.',
  'onboarding.custom.search.defaultDesc':
    '小鹈鹕 usa un backend di ricerca gestito. Nessuna chiave necessaria.',
  'onboarding.custom.search.configureDesc':
    'Porta la tua chiave di provider di ricerca (Tavily, Brave, ecc.). Configura in Impostazioni › Strumenti.',
  'onboarding.custom.embeddings.title': 'Embeddings',
  'onboarding.custom.embeddings.subtitle':
    'Come 小鹈鹕 genera gli embedding vettoriali per la ricerca nella memoria semantica.',
  'onboarding.custom.embeddings.defaultDesc':
    '小鹈鹕 utilizza un servizio di embedding gestito. Nessuna chiave API necessaria.',
  ...
  'onboarding.custom.memory.subtitle':
    'Come 小鹈鹕 ricorda il tuo contesto, le preferenze e le conversazioni precedenti.',
  'onboarding.custom.memory.defaultDesc':
    "小鹈鹕 gestisce automaticamente l'archiviazione e il recupero della memoria. Niente da configurare.",
  ...
  'misc.beta':
    '小鹈鹕 è in beta iniziale. Sentiti libero di condividere feedback o segnalare bug che incontri: ogni segnalazione ci aiuta a rilasciare più velocemente.',
  ...
  'privacy.shareAnonymizedDataDesc':
    'Aiuta a migliorare 小鹈鹕 condividendo report di crash ed eventi di utilizzo limitati per la privacy, inclusi un ID account stabile e i metadati della versione dell’app. Messaggi, chiavi wallet, chiavi API e token di sessione non vengono mai raccolti.',
  ...
  'privacy.autoHandoffMeetDesc':
    "Quando termina una chiamata Google Meet, l'orchestratore di 小鹈鹕 può leggere la trascrizione e svolgere azioni come redigere messaggi, pianificare follow-up o pubblicare riassunti nel tuo workspace Slack connesso. Disattivato di default.",
  ...
  'settings.about.starCta.title': 'Ti piace 小鹈鹕?',
  ...
  'settings.search.menuDesc':
    'Imposta come predefinito la ricerca gestita da 小鹈鹕 oppure collega il tuo provider con una chiave API.',
  'settings.search.description':
    "Scegli il motore di ricerca utilizzato dall'agente oppure disabilita completamente gli strumenti di ricerca. Gestito utilizza il backend di 小鹈鹕 (nessuna configurazione). Parallelo, Brave, Querit ed Exa vengono eseguiti direttamente dalla tua macchina usando la tua chiave API.",
  ...
  'settings.search.engineManagedLabel': '小鹈鹕 Gestito',
  'settings.search.engineManagedDesc':
    'Predefinito. Instradato tramite il backend di 小鹈鹕, attualmente basato su Exa: nessuna chiave API necessaria.',
  'settings.search.localManagedUnavailable':
    'La ricerca gestita da 小鹈鹕 non è disponibile per gli utenti locali. Aggiungi la tua chiave API Parallel, Brave, Querit o Exa per abilitare la ricerca web.',
  ...
  'settings.embeddings.requiresSignIn': 'Accesso 小鹈鹕 richiesto',
  'settings.embeddings.managedLoginRequired':
    'Gli embedding gestiti richiedono l’accesso a 小鹈鹕. Accedi per usare il backend 小鹈鹕.',
  'settings.embeddings.managedBannerIntro':
    'Gli embedding gestiti passano dal backend 小鹈鹕 e richiedono una sessione account 小鹈鹕.',
  ...
  'settings.embeddings.managedBannerRemoteSession':
    'Accedi di nuovo per aggiornare la sessione 小鹈鹕, oppure passa a un provider di embedding locale o con chiave personale.',
  ...
  'devices.betaText':
    'Questa funzionalità è attualmente in beta. Associa i telefoni iOS a questo 小鹈鹕 per usarli come client remoto.',
  ...
  'devices.emptyState':
    'Scansiona un codice QR sul tuo iPhone per collegarlo a questa sessione 小鹈鹕.',
  ...
  'devices.pairModal.instructions':
    "Apri l'app 小鹈鹕 sul tuo iPhone e scansiona questo codice.",
  ...
  'mcp.connectAuth.oauthHint':
    'Questo server usa OAuth. Accedi tramite il tuo browser per autorizzare 小鹈鹕.',
  ...
  'autonomy.maxActionsHelp':
    'Numero massimo di azioni dello strumento che un agente può eseguire per ora continuativa. Il nuovo valore si applica alla prossima chat. I cron job e i listener dei canali mantengono il limite attuale fino al riavvio di 小鹈鹕.',
  ...
  'settings.tools.chooseCapabilities': 'Scegli quali capacità 小鹈鹕 può usare per tuo conto.',
  ...
  'voice.providers.chip.cloud': '小鹈鹕 (Gestito)',
  'voice.providers.chip.cloudAria': 'Il provider gestito da 小鹈鹕 è sempre abilitato',
  ...
  'pttSettings.description':
    'Tieni premuto un tasto per parlare con 小鹈鹕 mentre sei in un’altra app. Al rilascio l’audio viene inviato; se «Leggi le risposte» è attivo, 小鹈鹕 risponde a voce.',
  ...
  'pttSettings.errorAccessibility':
    'macOS richiede l’autorizzazione Accessibilità per questa scorciatoia. Apri Impostazioni di sistema → Privacy e sicurezza → Accessibilità e attiva 小鹈鹕.',
  ...
  'pttSettings.errorUnsupportedWayland':
    'Le sessioni Wayland non supportano ancora le scorciatoie globali in 小鹈鹕: passa a una sessione X11 o usa l’interruttore di dettatura nell’app.',
  ...
  'chat.attachment.videoNotSupported':
    'Questo modello non può leggere i video. Puoi usare il livello Ragionamento di 小鹈鹕 per allegare il tuo video.',
  ...
  'chat.attachment.imageNotSupported':
    'Questo modello non può leggere le immagini. Puoi usare il livello Ragionamento di 小鹈鹕 per allegare la tua immagine.',
  ...
  'backend.cloudDescription':
    "Modelli veloci e potenti instradati attraverso il backend di 小鹈鹕. Pronti all'uso immediatamente.",
  'backend.privacyNote':
  ...
  'bootCheck.desktopDescription':
    '小鹈鹕 ha bisogno di un runtime per pensare. Scegli dove farlo girare.',
  'bootCheck.webDescription':
    "Sul web, 小鹈鹕 si connette a un runtime che controlli tu. Inserisci sotto URL e token di autenticazione, oppure scarica l'app desktop per farne girare uno direttamente sulla tua macchina.",
  ...
  'bootCheck.legacyDescription':
    'Un daemon 小鹈鹕 installato separatamente è già in esecuzione su questo dispositivo. Dobbiamo rimuoverlo prima che il runtime integrato possa subentrare.',
  ...
  'bootCheck.portConflictBody':
    'Un altro processo sta usando la porta di rete necessaria a 小鹈鹕. Tenteremo di risolvere il problema automaticamente.',
  ...
  'bootCheck.portConflictOwner':
    '{name} (PID {pid}) sta usando la porta di rete necessaria a 小鹈鹕.',
  ...
  'welcome.gatewaySessionErrorFallback':
    'Non è stato possibile completare l’accesso al momento. L’archivio di sessione non ha risposto in tempo (anche dopo un nuovo tentativo). Riavvia 小鹈鹕 e riprova.',
  ...
  'composio.expiredDescription':
    "Riconnettiti per riattivare gli strumenti {name}. 小鹈鹕 manterrà questa integrazione non disponibile finché non aggiornerai l'accesso a OAuth.",
  ...
  'mic.voiceNotCompiled':
    "La trascrizione vocale non è inclusa in questa versione dell'app. Aggiorna 小鹈鹕 per attivarla.",
  ...
  'app.connectionIndicator.connected': 'Connesso a 小鹈鹕 AI 🚀',
  ...
  'app.openhumanLink.notifications.permissionOff':
    "L'autorizzazione alle notifiche è disattivata. Abilita 小鹈鹕 in Impostazioni di sistema → Notifiche, quindi riprova.",
  'app.openhumanLink.notifications.triggerFailed':
    '小鹈鹕 non è riuscito ad attivare una notifica di sistema. Controlla le impostazioni di notifica del sistema operativo e riprova.',
  'app.openhumanLink.notifications.welcomeBody':
    'Riceverai avvisi qui quando qualcosa richiederà la tua attenzione.',
  'app.openhumanLink.notifications.welcomeTitle': "小鹈鹕 è pronto all'uso",
  ...
  'app.openhumanLink.notifications.sent':
    "Notifica di test inviata. Se non l'hai ricevuta, vai in Impostazioni di Sistema → Notifiche → 小鹈鹕, attiva Consenti notifiche e imposta lo Stile banner su Persistente.",
  ...
  'app.routeLoading.initializing': 'Inizializzazione di 小鹈鹕...',
  ...
  'channels.authMode.managed_dm': 'Accedi con 小鹈鹕',
  ...
  'channels.discord.authMode.oauth.description':
    'Installa il bot 小鹈鹕 sul tuo server Discord tramite OAuth.',
  'channels.discord.authMode.managed_dm.description':
    'Collega il tuo account personale Discord al bot 小鹈鹕.',
  ...
  'channels.telegram.authMode.managed_dm.description':
    'Invia un messaggio direttamente al bot 小鹈鹕 Telegram.',
  ...
  'channels.connectHelp.discord':
    'Scegli un metodo qui sotto: collega il tuo account tramite 小鹈鹕, installa il bot con OAuth oppure incolla il tuo token bot dal portale sviluppatori di Discord.',
  'channels.connectHelp.telegram':
    'Scegli un metodo qui sotto: scrivi al bot gestito di 小鹈鹕 per collegarlo, oppure incolla il tuo token bot da @BotFather.',
  ...
  'iosPair.error.invalidQr':
    'Codice QR non valido. Assicurati di scansionare un codice di abbinamento 小鹈鹕.',
  ...
  'iosPair.instructions':
    'Apri 小鹈鹕 sul desktop, vai in Impostazioni > Dispositivi e tocca "Associa telefono" per mostrare il codice QR.',
  'iosPair.retryScan': 'Riprova la scansione',
  'iosPair.scanQrCode': 'Scansione QR code',
  'iosPair.scannerOpening': 'Apertura scanner...',
  'iosPair.step.openDesktop': 'Apri 小鹈鹕 sul desktop',
  ...
  'composio.connect.permissionsNoteSuffix':
    "Le autorizzazioni proprie dell'agente 小鹈鹕 sono controllate sotto come toggle di lettura, scrittura e admin.",
  ...
  'composio.triggers.sessionExpired':
    'La tua sessione 小鹈鹕 è scaduta. Accedi di nuovo per caricare i trigger.',
  ...
  'daemon.serviceBlockingGate.title': 'Il core di 小鹈鹕 non è disponibile',
  ...
  'intelligence.diagram.imageAlt': "Ultimo diagramma dell'architettura 小鹈鹕 generato",
  ...
  'flows.nodeSummary.toolCall.pickNative': 'Esegue uno strumento 小鹈鹕 (scegline uno)',
  ...
  'rewards.community.activityStreakHint': 'Giorni consecutivi di attività su 小鹈鹕.',
  ...
  'rewards.community.roleClaimDesc':
    'Hai sbloccato i ruoli Discord ma non ti sei ancora unito al server 小鹈鹕. Unisciti per assegnarli automaticamente.',
  ...
  'settings.ai.providers.managedDetail': '小鹈鹕 sceglie un modello per ogni attività',
  ...
  'settings.ai.openhumanDefault': '小鹈鹕 (predefinito)',
  ...
  'settings.ai.managedSourceLabel': 'Gestito da 小鹈鹕',
  ...
  'settings.ai.routing.managedDesc':
    '小鹈鹕 eseguirà tutte le inferenze nel cloud, sceglierà il miglior modello per il compito, ottimizzerà i costi e manterrà le impostazioni di routing più sicure.',
  'settings.ai.routing.managedMsg':
    '小鹈鹕 gestirà tutte le inferenze per ogni carico di lavoro e sceglierà automaticamente il percorso migliore in termini di costo, qualità e sicurezza.',
  ...
  'settings.composio.confirmWarning':
    'Le tue integrazioni esistenti (Gmail, Slack, GitHub, ecc. collegate tramite 小鹈鹕) non saranno visibili: risiedono nel tenant Composio gestito da 小鹈鹕.',
  ...
  'settings.composio.modeManaged': 'Gestita (小鹈鹕 lo gestisce per te)',
  'settings.composio.modeManagedDesc':
    "小鹈鹕 fa da proxy per le chiamate degli strumenti tramite il nostro backend (consigliato). L'autenticazione è mediata; non incolli mai una chiave API Composio. I webhook sono completamente instradati.",
  ...
  'settings.developerMenu.tools.desc':
    'Abilita o disabilita le capacità che 小鹈鹕 può usare per tuo conto',
  ...
  'settings.developerMenu.mcpServer.desc':
    'Configura i client MCP esterni per connettersi a 小鹈鹕',
  ...
  'settings.mcpServer.binaryPathNotFound':
    '小鹈鹕 binario non trovato. Se esegui dal sorgente, compila con: cargo build --bin openhuman-core',
  ...
  'settings.mascot.colorAria': '小鹈鹕 colore',
  ...
  'settings.mascot.libraryUnavailable': '小鹈鹕 libreria non disponibile',
  'settings.mascot.title': '小鹈鹕',
  'settings.mascot.loadingLibrary': 'Caricamento libreria 小鹈鹕…',
  ...
  'settings.mascot.localDefault': '小鹈鹕 locale (predefinito)',
  'settings.mascot.menuTitle': 'Mascotte',
  'settings.mascot.menuDesc': "Scegli il colore della mascotte usato in tutta l'app",
  'settings.mascot.noCharacters': 'Nessun personaggio 小鹈鹕 disponibile',
  ...
  'settings.memoryWindow.description':
    "Quanto contesto ricordato 小鹈鹕 inietta in ogni nuova esecuzione dell'agente. Finestre più grandi fanno sentire l'agente più consapevole delle conversazioni passate ma usano più token (e costano di più) a ogni esecuzione.",
  ...
  'skills.meetingBots.serverOverloaded':
    '小鹈鹕 è sottoposto a un carico elevato in questo momento. Riprova tra qualche minuto.',
  ...
  'skills.meetingBots.history.runWith小鹈鹕': 'Esegui con 小鹈鹕',
  ...
  'skills.meetingBots.defaults.watchCalendarDesc':
    'Consenti a 小鹈鹕 di monitorare il tuo calendario connesso per poter partecipare automaticamente o richiedere conferma per le riunioni in base alle politiche seguenti. Questo è separato dalle notifiche di promemoria delle riunioni.',
  ...
  'walkthrough.steps.brainTab.content':
    'Brain è il grafo della memoria: il posto dove vedere cosa sa 小鹈鹕 e come si collegano le idee.',
  ...
  'settings.mascot.noCharactersAvailable': 'Nessun personaggio 小鹈鹕 disponibile',
  ...
  'devOptions.menuToolsDesc':
    'Abilita o disabilita le funzionalità che 小鹈鹕 può utilizzare per tuo conto',
  ...
  'harnessInit.subtitle': '小鹈鹕 sta preparando i componenti necessari al primo avvio.',
  ...
  'harnessInit.failedMessage':
    "Alcuni passaggi di configurazione non sono stati completati. Puoi riprovare o continuare: 小鹈鹕 userà un'alternativa integrata.",
  ...
  'harnessInit.backgroundHint':
    'Puoi continuare a usare 小鹈鹕 mentre questa operazione termina.',

  'keyring.consent.title': 'Archivio sicuro non disponibile',
  'keyring.consent.description':
    "Il portachiavi del sistema operativo non è accessibile. 小鹈鹕 necessita del tuo permesso per archiviare i segreti utilizzando l'archiviazione locale crittografata.",
  ...
  'memory.health.remediation.auth_missing':
    'Nessuna credenziale per gli embedding trovata. Accedi a 小鹈鹕 o configura embedding Ollama locali in Connessioni → Chiavi API → Incorporamenti.',
  ...
  'memory.health.remediation.storage_unavailable':
    "小鹈鹕 non riesce a scrivere nella sua memoria: il disco o la scheda SD sembra guasto, pieno o di sola lettura. Controlla l'unità e libera spazio; l'elaborazione della memoria riprenderà automaticamente quando lo spazio di archiviazione tornerà scrivibile.",
  ...
  'onboarding.custom.vault.defaultDesc':
    'Usa le impostazioni di memoria predefinite gestite da 小鹈鹕. Il percorso del vault e la salute della sincronizzazione possono essere verificati in seguito.',
  ...
  'onboarding.custom.vault.localDisabledReason':
    'La configurazione gestita richiede il login a 小鹈鹕 e non è disponibile in modalità locale.',
  ...
  'vaultHealth.writableLabel': 'Il vault è scrivibile da 小鹈鹕',
  'vaultHealth.writableRecovery':
    '小鹈鹕 non riesce ancora a scrivere in questo vault. Concedi i permessi di scrittura e aggiorna.',
  ...
  'memoryData.workspaceVaultDesc':
    '小鹈鹕 scrive le note di memoria generate in memory_tree/content.',
  ...
  'memoryData.internalFilesDesc':
    'Indici, stato della coda e riepiloghi sono gestiti da 小鹈鹕 per mantenere efficiente il richiamo e la sincronizzazione.',
  ...
  'settings.gateway.description':
    'Il core può girare in un container, su un’altra macchina via SSH o in un container su un’altra macchina. 小鹈鹕 lo avvia, si collega e lo arresta quando passi ad altro.',
