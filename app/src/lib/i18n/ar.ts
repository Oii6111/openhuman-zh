...
const messages: TranslationMap = {
  ...
  'share.defaultHeadline': 'شاهد ما فعله وكيل 小鹈鹕 الخاص بي للتو',
  'share.defaultAgentName': 'وكيلي',
  'share.defaultCaption': 'شاهد ما فعله وكيل 小鹈鹕 الخاص بي للتو.',
  'share.captionWithHeadline': '{headline}. تم الإنجاز بواسطة وكيل 小鹈鹕 الخاص بي.',
  ...
  'feedback.welcome.body':
    'أخبرنا بما ينجح وما ينقص وما الذي سيجعل 小鹈鹕 أفضل. انشر فكرة، وصوّت على ما يقترحه الآخرون، وشاهد أفضل الأفكار ترتقي إلى قمة خارطة طريقنا.',
  ...
  'rewards.welcome.body':
    'اكسب نقاطًا أثناء استخدامك 小鹈鹕 ودعوتك للآخرين، وحافظ على سلسلة حضورك، واستبدل ما كسبته، كل ذلك متتبَّع في مكان واحد.',
  ...
  'settings.core.applyRestartNote': 'يؤدي الحفظ إلى إعادة تشغيل 小鹈鹕 لإعادة الاتصال.',
  ...
  'conversations.toolFailure.missingPermission.cause': 'لا يملك 小鹈鹕 الإذن للقيام بهذا بعد.',
  ...
  'conversations.toolFailure.serviceUnavailable.cause':
    'إحدى الخدمات التي يحتاجها 小鹈鹕 غير متوفرة مؤقتًا.',
  'conversations.toolFailure.serviceUnavailable.next':
    'سيحاول 小鹈鹕 مرة أخرى قريبًا: لا حاجة لأي إجراء.',
  ...
  'conversations.toolFailure.modelConnection.cause':
    'تعذّر على 小鹈鹕 الوصول إلى نموذج الذكاء الاصطناعي.',
  'conversations.toolFailure.modelConnection.next':
    'تحقّق من اتصالك أو إعدادات النموذج؛ سيعيد 小鹈鹕 المحاولة.',
  'conversations.toolFailure.timeout.cause': 'استغرق الإجراء وقتًا طويلاً وتم إيقافه.',
  'conversations.toolFailure.timeout.next': 'سيعيد 小鹈鹕 المحاولة، أو يمكنك إعادتها يدويًا.',
  ...
  'conversations.toolFailure.approvalExpired.next':
    'اطلبه مجددًا لتشغيله: لن يعيد 小鹈鹕 المحاولة من تلقاء نفسه.',
  ...
  'orchPage.medulla.tagline': 'نموذج التنسيق من 小鹈鹕',
  'orchPage.medulla.body':
    'Medulla هو نموذج اللغة الكبير الذي طوّرته 小鹈鹕 خصيصًا، مصمَّم لتنسيق آلاف الوكلاء في آنٍ واحد، بنافذة سياق تتسع لـ 10 ملايين توكن وتنسيق منخفض التكلفة بشكل جذري.',
  ...
  'orchPage.medulla.subscriberTitle': 'مشتركو 小鹈鹕',
  'orchPage.medulla.subscriberNote': 'عند إطلاق Medulla، سيكون حصريًا لمشتركي 小鹈鹕.',
  ...
  'orchPage.connections.initDesc':
    'أنشئ وكيلًا فرعيًا جديدًا يعمل إلى جانبك. افتح محادثة الوكيل وصف الدور والهدف والأدوات التي يجب أن يستخدمها: يقوم 小鹈鹕 بتجهيز نسخة مخصصة يمكنك توجيهها من هنا.',
  ...
  'tinyplaceOrchestration.master.preview': 'تنسيق مباشر بينك وبين 小鹈鹕.',
  ...
  'tinyplaceOrchestration.composer.placeholder': 'راسل 小鹈鹕…',
  ...
  'welcome.logoAlt': '小鹈鹕',
  'welcome.title': 'مرحبًا بك في 小鹈鹕',
  ...
  'welcome.resetErrorFallback':
    'تعذّر مسح بيانات التطبيق. يرجى إنهاء 小鹈鹕 وإعادة فتحه، ثم حاول مجدداً.',
  ...
  'home.statusCoreUnreachable':
    'العملية الأساسية المحلية لا تستجيب. قد تكون عملية 小鹈鹕 في الخلفية قد تعطلت أو فشلت في البدء.',
  ...
  'rewards.localUnavailable':
    'تسجيل الدخول المحلي لا يمنح مكافآت أو قسائم أو رصيد إحالة. لكسب المكافآت، سجّل الخروج ثم تابِع بتسجيل الدخول باستخدام حساب 小鹈鹕.',
  ...
  'onboarding.welcome': 'مرحبًا. أنا 小鹈鹕.',
  ...
  'onboarding.finishDesc': 'انتهيت! ابدأ استخدام 小鹈鹕.',
  'onboarding.skip': 'تخطي',
  'onboarding.getStarted': 'ابدأ الآن',
  'onboarding.runtimeChoice.title': 'كيف تريد تشغيل 小鹈鹕؟',
  ...
  'onboarding.runtimeChoice.cloud.tagline': 'دع 小鹈鹕 يدير كل شيء نيابةً عنك.',
  ...
  'onboarding.custom.defaultSubtitle': 'دع 小鹈鹕 يديره نيابةً عنك.',
  ...
  'onboarding.custom.inference.defaultDesc':
    'يُوجّه 小鹈鹕 كل عبء عمل إلى نموذج افتراضي مناسب. بدون مفاتيح أو إعداد.',
  ...
  'onboarding.custom.voice.defaultDesc':
    'يأتي 小鹈鹕 مع STT/TTS مُدار يعمل تلقائيًا. لا شيء يحتاج إلى إعداد.',
  ...
  'onboarding.custom.oauth.defaultDesc':
    'يشغّل 小鹈鹕 مساحة عمل Composio مُدارة. نقرة واحدة لتوصيل كل خدمة لاحقًا.',
  ...
  'onboarding.custom.search.subtitle': 'كيف يبحث 小鹈鹕 على الويب نيابةً عنك.',
  'onboarding.custom.search.defaultDesc': 'يستخدم 小鹈鹕 خادم بحث مُدار. لا حاجة لمفاتيح.',
  'onboarding.custom.search.configureDesc':
    'استخدم مفتاح مزود البحث الخاص بك (Tavily أو Brave إلخ). اضبطه من الإعدادات › الأدوات.',
  'onboarding.custom.embeddings.title': 'Embeddings',
  'onboarding.custom.embeddings.subtitle':
    'كيف يُولِّد 小鹈鹕 تضمينات المتجهات للبحث الدلالي في الذاكرة.',
  'onboarding.custom.embeddings.defaultDesc':
    'يستخدم 小鹈鹕 خدمة تضمين مُدارة. لا حاجة لمفتاح API.',
  ...
  'onboarding.custom.memory.subtitle': 'كيف يتذكر 小鹈鹕 سياقك وتفضيلاتك ومحادثاتك السابقة.',
  'onboarding.custom.memory.defaultDesc':
    'يدير 小鹈鹕 تخزين الذاكرة واسترجاعها تلقائيًا. لا شيء يحتاج إلى إعداد.',
  ...
  'misc.beta':
    '小鹈鹕 في مرحلة تجريبية مبكرة. لا تتردد في مشاركة ملاحظاتك أو الإبلاغ عن أي أخطاء تواجهها: كل تقرير يساعدنا على الإنجاز بشكل أسرع.',
  ...
  'privacy.shareAnonymizedDataDesc':
    'ساعد في تحسين 小鹈鹕 من خلال مشاركة تقارير أعطال وأحداث استخدام محدودة الخصوصية، بما في ذلك معرّف حساب ثابت وبيانات إصدار التطبيق. لا تُجمع الرسائل أو مفاتيح المحافظ أو مفاتيح API أو رموز الجلسات أبدًا.',
  'privacy.meetingFollowUps': 'متابعات الاجتماعات',
  'privacy.autoHandoffMeet': 'تسليم نسخ Google Meet تلقائيًا إلى المنسق',
  'privacy.autoHandoffMeetDesc':
    'عند انتهاء مكالمة Google Meet، يمكن لمنسق 小鹈鹕 قراءة النسخة المكتوبة واتخاذ إجراءات كصياغة الرسائل أو جدولة المتابعات أو نشر الملخصات في مساحة عمل Slack المتصلة. معطّل افتراضيًا.',
  ...
  'settings.about.starCta.title': 'هل يعجبك 小鹈鹕؟',
  ...
  'settings.search.description':
    'اختر محرك البحث الذي يستخدمه الوكيل، أو عطّل أدوات البحث بالكامل. يستخدم الوضع المُدار واجهة خلفية 小鹈鹕 (بدون إعداد). تعمل محركات Parallel وBrave وQuerit وExa مباشرةً من جهازك باستخدام مفتاح API الخاص بك.',
  ...
  'settings.search.engineManagedLabel': '小鹈鹕 مُدار',
  'settings.search.engineManagedDesc':
    'الإعداد الافتراضي. يتم توجيهه عبر خادم 小鹈鹕 الخلفي، المدعوم حاليًا بواسطة Exa: لا حاجة إلى مفتاح API.',
  'settings.search.localManagedUnavailable':
    'بحث 小鹈鹕 المُدار غير متاح للمستخدمين المحليين. أضف مفتاح Parallel أو Brave أو Querit أو Exa الخاص بك لتفعيل البحث على الويب.',
  ...
  'settings.embeddings.requiresSignIn': 'يتطلب تسجيل الدخول إلى 小鹈鹕',
  'settings.embeddings.managedLoginRequired':
    'تتطلب التضمينات المُدارة تسجيل الدخول إلى 小鹈鹕. سجّل الدخول لاستخدام خلفية 小鹈鹕.',
  'settings.embeddings.managedBannerIntro':
    'تمر التضمينات المُدارة عبر خلفية 小鹈鹕 وتتطلب جلسة حساب 小鹈鹕.',
  ...
  'settings.embeddings.managedBannerRemoteSession':
    'سجّل الدخول مرة أخرى لتحديث جلسة 小鹈鹕، أو انتقل إلى مزوّد تضمينات محلي أو بمفتاحك الخاص.',
  ...
  'devices.betaText':
    'هذه الميزة في مرحلة تجريبية حالياً. اربط هواتف iOS بـ 小鹈鹕 لاستخدامها كعميل بعيد.',
  ...
  'devices.emptyState': 'قم بمسح QR code على جهاز iPhone الخاص بك لتوصيله بجلسة 小鹈鹕 هذه.',
  ...
  'devices.pairModal.instructions': 'افتح تطبيق 小鹈鹕 على iPhone وامسح هذا الرمز.',
  ...
  'mcp.connectAuth.oauthHint':
    'يستخدم هذا الخادم OAuth. سجّل الدخول عبر متصفحك للسماح لـ 小鹈鹕.',
  ...
  'autonomy.maxActionsHelp':
    'الحد الأقصى لإجراءات الأداة التي يمكن للوكيل تنفيذها في كل ساعة متجددة. تسري القيمة الجديدة على محادثتك التالية. تحتفظ المهام المجدولة ومستمعو القنوات بحدودهم الحالية حتى تعيد تشغيل 小鹈鹕.',
  ...
  'settings.tools.chooseCapabilities':
    'اختر الإمكانات التي يمكن لـ 小鹈鹕 استخدامها نيابةً عنك.',
  ...
  'voice.providers.chip.cloud': '小鹈鹕 (مُدار)',
  'voice.providers.chip.cloudAria': 'موفر 小鹈鹕 المُدار مُفعَّل دائماً',
  ...
  'pttSettings.description':
    'اضغط مفتاحًا باستمرار للتحدث إلى 小鹈鹕 أثناء وجودك في تطبيق آخر. تحرير المفتاح يُرسل التسجيل؛ إذا كان «قراءة الردود» مفعَّلًا، ينطق 小鹈鹕 الرد بصوت عالٍ.',
  ...
  'pttSettings.errorAccessibility':
    'يحتاج macOS إلى إذن إمكانية الوصول لهذا الاختصار. افتح إعدادات النظام ← الخصوصية والأمان ← إمكانية الوصول وفعّل 小鹈鹕.',
  ...
  'pttSettings.errorUnsupportedWayland':
    'جلسات Wayland لا تدعم بعد الاختصارات العامة في 小鹈鹕: انتقل إلى جلسة X11 أو استخدم زر الإملاء داخل التطبيق.',
  ...
  'chat.attachment.videoNotSupported':
    'لا يمكن لهذا النموذج قراءة مقاطع الفيديو. يمكنك استخدام مستوى التفكير من 小鹈鹕 لإرفاق الفيديو.',
  ...
  'chat.attachment.imageNotSupported':
    'لا يمكن لهذا النموذج قراءة الصور. يمكنك استخدام مستوى التفكير من 小鹈鹕 لإرفاق صورتك.',
  ...
  'bootCheck.desktopDescription': 'يحتاج 小鹈鹕 إلى بيئة تشغيل للعمل. اختر مكانها.',
  'bootCheck.webDescription':
    'على الويب، يتصل 小鹈鹕 ببيئة تشغيل تتحكم فيها. أدخل عنوان URL الخاص بها ورمز المصادقة أدناه، أو احصل على تطبيق سطح المكتب لتشغيلها مباشرة على جهازك.',
  ...
  'bootCheck.legacyDescription':
    'خدمة 小鹈鹕 مثبّتة بشكل منفصل تعمل بالفعل على هذا الجهاز. نحتاج إلى إزالتها قبل أن تتولى بيئة التشغيل المدمجة.',
  ...
  'bootCheck.portConflictBody':
    'هناك عملية أخرى تستخدم منفذ الشبكة الذي يحتاجه 小鹈鹕. سنحاول إصلاح ذلك تلقائيًا.',
  ...
  'bootCheck.portConflictOwner': '{name} (المعرّف {pid}) يستخدم منفذ الشبكة الذي يحتاجه 小鹈鹕.',
  ...
  'welcome.gatewaySessionErrorFallback':
    'تعذّر إتمام تسجيل الدخول في الوقت الحالي. لم يستجب تخزين الجلسة في الوقت المحدد (حتى بعد إعادة المحاولة). يرجى إعادة تشغيل 小鹈鹕 والمحاولة مرة أخرى.',
  ...
  'composio.expiredDescription':
    'أعد الاتصال لإعادة تمكين أدوات {name}. 小鹈鹕 سيبقي هذا التكامل غير متاح حتى تقوم بتحديث وصول OAuth.',
  ...
  'mic.voiceNotCompiled':
    'خاصية تحويل الصوت إلى نص غير متوفرة في هذا الإصدار من التطبيق. حدّث 小鹈鹕 لتفعيلها.',
  ...
  'app.connectionIndicator.connected': 'متصل بـ 小鹈鹕 AI 🚀',
  ...
  'app.openhumanLink.notifications.permissionOff':
    'إذن الإشعارات معطّل. فعّل 小鹈鹕 في إعدادات النظام → الإشعارات، ثم أعد المحاولة.',
  'app.openhumanLink.notifications.triggerFailed':
    'تعذّر على 小鹈鹕 إطلاق إشعار النظام. تحقّق من إعدادات إشعارات نظام التشغيل وأعد المحاولة.',
  'app.openhumanLink.notifications.welcomeBody': 'ستصلك تنبيهات هنا عندما يتطلب أمر ما انتباهك.',
  'app.openhumanLink.notifications.welcomeTitle': '小鹈鹕 جاهز للعمل',
  ...
  'app.openhumanLink.notifications.sent':
    'تم إرسال إشعار اختباري. إذا لم تستلمه، انتقل إلى إعدادات النظام ← الإشعارات ← 小鹈鹕، فعّل "السماح بالإشعارات"، واضبط نمط الشعار على "مستمر".',
  ...
  'app.routeLoading.initializing': 'جارٍ تهيئة 小鹈鹕...',
  ...
  'channels.authMode.managed_dm': 'قم بتسجيل الدخول باستخدام 小鹈鹕',
  ...
  'channels.discord.authMode.oauth.description':
    'قم بتثبيت الروبوت 小鹈鹕 على خادم Discord الخاص بك عبر OAuth.',
  'channels.discord.authMode.managed_dm.description':
    'اربط حسابك الشخصي في Discord بالروبوت 小鹈鹕.',
  ...
  'channels.telegram.authMode.managed_dm.description':
    'أرسل رسالة إلى الروبوت 小鹈鹕 Telegram مباشرة.',
  ...
  'channels.connectHelp.discord':
    'اختر طريقة أدناه: اربط حسابك عبر 小鹈鹕، أو ثبّت البوت باستخدام OAuth، أو الصق رمز البوت الخاص بك من بوابة مطوري Discord.',
  'channels.connectHelp.telegram':
    'اختر طريقة أدناه: راسل بوت 小鹈鹕 المُدار لربطه، أو الصق رمز البوت الخاص بك من @BotFather.',
  ...
  'iosPair.error.invalidQr': 'رمز QR غير صالح. تأكد من مسح رمز إقران 小鹈鹕.',
  ...
  'iosPair.instructions':
    'افتح 小鹈鹕 على سطح المكتب، اذهب إلى الإعدادات > الأجهزة، واضغط «إقران الهاتف» لعرض رمز QR.',
  'iosPair.retryScan': 'أعد محاولة المسح',
  'iosPair.scanQrCode': 'المسح الضوئي QR code',
  'iosPair.scannerOpening': 'فتح الماسح الضوئي...',
  'iosPair.step.openDesktop': 'افتح 小鹈鹕 على سطح المكتب',
  ...
  'composio.connect.permissionsNoteSuffix':
    'أذونات وكيل 小鹈鹕 الخاصة يتم التحكم بها أدناه عبر مفاتيح القراءة والكتابة والإدارة.',
  ...
  'composio.triggers.sessionExpired':
    'انتهت صلاحية جلسة 小鹈鹕. سجّل الدخول مرة أخرى لتحميل المشغّلات.',
  ...
  'daemon.serviceBlockingGate.title': 'نواة 小鹈鹕 غير متاحة',
  ...
  'intelligence.diagram.imageAlt': 'أحدث مخطط بنية 小鹈鹕 المُولَّد',
  ...
  'flows.nodeSummary.toolCall.pickNative': 'يُشغّل أداة من 小鹈鹕 (اختر واحدة)',
  ...
  'rewards.community.activityStreakHint': 'أيام متتالية كنت نشطًا فيها على 小鹈鹕.',
  ...
  'rewards.community.roleClaimDesc':
    'لقد فتحت رتب Discord لكنك لم تنضم بعد إلى خادم 小鹈鹕. انضم ليتم تعيينها تلقائيًا.',
  ...
  'settings.ai.providers.managedDetail': 'يختار 小鹈鹕 نموذجًا لكل مهمة',
  ...
  'settings.ai.openhumanDefault': '小鹈鹕 (افتراضي)',
  ...
  'settings.ai.managedSourceLabel': 'مُدار بواسطة 小鹈鹕',
  ...
  'settings.composio.confirmWarning':
    'تكاملاتك الحالية (Gmail، Slack، GitHub، إلخ المرتبطة عبر 小鹈鹕) لن تكون مرئية: فهي موجودة في مستأجر Composio المُدار من 小鹈鹕.',
  ...
  'settings.composio.modeManaged': 'مُدار (小鹈鹕 يتولى الأمر نيابةً عنك)',
  'settings.composio.modeManagedDesc':
    'يقوم 小鹈鹕 بتمرير استدعاءات الأدوات عبر خادمنا الخلفي (موصى به). تتم وساطة المصادقة؛ لن تلصق مفتاح Composio API. الـ webhooks مُوجَّهة بالكامل.',
  ...
  'settings.developerMenu.tools.desc':
    'تفعيل أو تعطيل الإمكانات التي يمكن لـ 小鹈鹕 استخدامها نيابةً عنك',
  ...
  'settings.developerMenu.mcpServer.desc': 'تكوين عملاء MCP الخارجيين للاتصال بـ 小鹈鹕',
  ...
  'settings.mcpServer.binaryPathNotFound':
    '小鹈鹕 لم يتم العثور على الثنائي. في حالة التشغيل من المصدر، قم بالإنشاء باستخدام: cargo build --bin openhuman-core',
  ...
  'settings.agentAccess.tinyplaceAutopilot.desc':
    'دع 小鹈鹕 يتصرف على tiny.place بمفرده. وفق جدول زمني، يبحث عن عمل مجدٍ (المكافآت المفتوحة أولًا)، وينجز ما يناسب مهاراته ويتصرف من هويتك. يعمل دون إشراف ويمكنه الإنفاق، لذا أبقِه على devnet أثناء الاختبار. معطّل افتراضيًا.',
  ...
  'settings.mascot.colorAria': '小鹈鹕 اللون',
  ...
  'settings.memoryWindow.description':
    'مقدار السياق المحفوظ الذي يحقنه 小鹈鹕 في كل تشغيل وكيل جديد. النوافذ الأكبر تمنح الوكيل وعيًا أكبر بالمحادثات السابقة، لكنها تستخدم رموزًا أكثر وتكلّف أكثر في كل تشغيل.',
  ...
  'skills.meetingBots.busyTitle': '小鹈鹕 مشغول',
  'skills.meetingBots.comingSoon': 'قريبًا',
  'skills.meetingBots.couldNotLeaveTitle': 'تعذّر مغادرة الاجتماع',
  'skills.meetingBots.couldNotStartTitle': 'تعذّر بدء 小鹈鹕',
  'skills.meetingBots.displayName': 'الاسم المعروض',
  'skills.meetingBots.failedToStart': 'فشل تشغيل 小鹈鹕.',
  'skills.meetingBots.joiningMessage': 'يجب أن يظهر كمشارك في غضون ثوانٍ.',
  'skills.meetingBots.joiningTitle': '小鹈鹕 ينضم إلى الاجتماع',
  'skills.meetingBots.meetingLink': 'رابط الاجتماع',
  'skills.meetingBots.modalAriaLabel': 'إرسال 小鹈鹕 إلى اجتماع',
  'skills.meetingBots.modalDesc': 'وصف النافذة',
  'skills.meetingBots.modalTitle': 'إرسال 小鹈鹕 إلى اجتماع',
  ...
  'skills.meetingBots.serverOverloaded':
    'يشهد 小鹈鹕 ضغطًا كبيرًا في الوقت الحالي. يُرجى المحاولة مرة أخرى بعد بضع دقائق.',
  ...
  'skills.meetingBots.wakePhraseHint': 'مرحباً 小鹈鹕',
  ...
  'skills.meetingBots.history.runWith小鹈鹕': 'تشغيل مع 小鹈鹕',
  ...
  'skills.meetingBots.defaults.watchCalendarDesc':
    'اسمح لـ 小鹈鹕 بمراقبة التقويم المتصل حتى يتمكن من الانضمام تلقائياً أو مطالبتك بالاجتماعات بناءً على السياسات أدناه. هذا منفصل عن إشعارات تذكير الاجتماعات.',
  ...
  'walkthrough.steps.brainTab.content':
    'Brain هو مخطط الذاكرة: المكان الذي تفحص فيه ما يعرفه 小鹈鹕 وكيف ترتبط الأفكار.',
  ...
  'settings.mascot.noCharactersAvailable': 'لا توجد شخصيات 小鹈鹕 متاحة بعد',
  ...
  'devOptions.menuToolsDesc': 'تمكين أو تعطيل الإمكانات التي يمكن أن يستخدمها 小鹈鹕 نيابة عنك',
  ...
  'harnessInit.subtitle': 'يقوم 小鹈鹕 بتجهيز المكونات التي يحتاجها عند التشغيل الأول.',
  ...
  'harnessInit.failedMessage':
    'لم تكتمل بعض خطوات الإعداد. يمكنك إعادة المحاولة أو المتابعة: سيستخدم 小鹈鹕 بديلاً مدمجاً.',
  ...
  'harnessInit.backgroundHint': 'يمكنك مواصلة استخدام 小鹈鹕 حتى ينتهي هذا.',

  'keyring.consent.title': 'التخزين الآمن غير متاح',
  'keyring.consent.description':
    'سلسلة مفاتيح نظام التشغيل غير متاحة. يحتاج 小鹈鹕 إلى إذنك لتخزين الأسرار باستخدام التخزين المشفّر المحلي بدلاً من ذلك.',
  ...
  'memory.health.remediation.auth_missing':
    'لم يتم العثور على بيانات اعتماد التضمينات. سجّل الدخول إلى 小鹈鹕، أو أعدّ تضمينات Ollama المحلية في الاتصالات → مفاتيح API → التضمينات.',
  ...
  'memory.health.remediation.storage_unavailable':
    'تعذّر على 小鹈鹕 الكتابة إلى تخزين الذاكرة: يبدو أن القرص أو بطاقة SD معطوبة أو ممتلئة أو للقراءة فقط. تحقّق من محرك الأقراص وحرّر بعض المساحة؛ ستُستأنف معالجة الذاكرة تلقائيًا بمجرد أن يصبح التخزين قابلاً للكتابة مرة أخرى.',
  ...
  'onboarding.custom.vault.defaultDesc':
    'استخدم الإعدادات الافتراضية لذاكرة 小鹈鹕 المُدارة. يمكن مراجعة مسار الخزينة وصحة المزامنة لاحقًا.',
  'onboarding.custom.vault.configureDesc':
    'راجع ملكية الخزينة، وشغّل فحوصات الصحة، واضبط عناصر التحكم في الذاكرة الآن.',
  'onboarding.custom.vault.localDisabledReason':
    'يتطلب الإعداد المُدار تسجيل الدخول إلى 小鹈鹕 وغير متاح في الوضع المحلي.',
  ...
  'vaultHealth.writableLabel': 'الخزينة قابلة للكتابة بواسطة 小鹈鹕',
  'vaultHealth.writableRecovery':
    'لا يستطيع 小鹈鹕 الكتابة في هذه الخزينة بعد. امنح أذونات الكتابة ثم حدّث.',
  ...
  'memoryData.workspaceVaultDesc':
    'يكتب 小鹈鹕 ملاحظات الذاكرة المُولَّدة إلى memory_tree/content.',
  ...
  'memoryData.internalFilesDesc':
    'تُدار الفهارس وحالة قائمة الانتظار والملخصات بواسطة 小鹈鹕 للحفاظ على سلامة الاسترجاع والمزامنة.',
  ...
  'settings.gateway.description':
    'يمكن للنواة أن تعمل داخل حاوية، أو على جهاز آخر عبر SSH، أو داخل حاوية على جهاز آخر. يشغّلها 小鹈鹕 ويتصل بها ثم يوقفها عند انتقالك إلى مكان آخر.',
