...
const messages: TranslationMap = {
  ...
  'share.defaultHeadline': '看看我的 小鹈鹕 智能体刚刚做了什么',
  'share.defaultAgentName': '我的智能体',
  'share.defaultCaption': '看看我的 小鹈鹕 智能体刚刚做了什么。',
  'share.captionWithHeadline': '{headline}。由我的 小鹈鹕 智能体制作。',
  ...
  'feedback.welcome.body':
    '告诉我们什么行得通、缺少什么，以及怎样能让 小鹈鹕 变得更好。发布一个想法，为他人的建议投票，看着最棒的那些一路升到我们路线图的顶端。',
  ...
  'rewards.welcome.body':
    '在使用 小鹈鹕 和邀请他人的过程中赚取积分，保持你的连续记录不断，并兑换你所赚取的一切：全部在一处追踪。',
  ...
  'settings.core.applyRestartNote': '保存后 小鹈鹕 将重启以重新连接。',
  ...
  'conversations.toolFailure.missingPermission.cause': '小鹈鹕 目前还没有执行此操作的权限。',
  ...
  'conversations.toolFailure.serviceUnavailable.cause': '小鹈鹕 需要的某项服务暂时不可用。',
  'conversations.toolFailure.serviceUnavailable.next': '小鹈鹕 稍后会重试：无需任何操作。',
  ...
  'conversations.toolFailure.modelConnection.cause': '小鹈鹕 无法连接到 AI 模型。',
  'conversations.toolFailure.modelConnection.next':
    '请检查你的网络连接或模型设置；小鹈鹕 将会重试。',
  'conversations.toolFailure.timeout.cause': '操作耗时过长，已被停止。',
  'conversations.toolFailure.timeout.next': '小鹈鹕 会重试，你也可以手动重试。',
  ...
  'conversations.toolFailure.approvalExpired.next': '再次提出以执行它：小鹈鹕 不会自行重试。',
  ...
  'orchPage.medulla.tagline': '小鹈鹕 的编排模型',
  'orchPage.medulla.body':
    'Medulla 是 小鹈鹕 从零打造的自研大语言模型，专为同时编排数千个智能体而设计：具备 1000 万 token 的上下文窗口和极低成本的编排能力。',
  'orchPage.medulla.featAgents': '数千个智能体',
  'orchPage.medulla.featContext': '10M token 上下文',
  'orchPage.medulla.featCost': '低成本编排',
  'orchPage.medulla.subscriberTitle': '小鹈鹕 订阅用户',
  'orchPage.medulla.subscriberNote': 'Medulla 上线后将仅面向 小鹈鹕 订阅用户开放。',
  ...
  'orchPage.connections.initDesc':
    '启动一个新的子智能体与你协作。打开智能体聊天，描述它的角色、目标和所需工具：小鹈鹕 会创建一个专属实例，你可以在这里进行操控。',
  ...
  'tinyplaceOrchestration.master.preview': '你和 小鹈鹕 之间的直接协调。',
  ...
  'tinyplaceOrchestration.composer.placeholder': '给 小鹈鹕 发消息…',
  ...
  'welcome.resetErrorFallback': '无法清除应用数据。请退出并重新打开 小鹈鹕，然后重试。',
  ...
  'home.statusCoreUnreachable': '本地核心 sidecar 无响应。小鹈鹕 后台进程可能已崩溃或未能启动。',
  ...
  'skills.explorer.scopeUser': '用户',
  'skills.explorer.scopeProject': '项目',
  'skills.explorer.scopeLegacy': '旧版',
  ...
  'entityAssociations.retry': '重试',
  'entityAssociations.empty': '暂无关联。',
  'entityAssociations.emptyHint': '当实体开始共享连接时，最强的关联将在此显示。',
  'entityAssociations.namespaceLabel': '命名空间',
  'entityAssociations.namespaceAll': '所有命名空间',
  'entityAssociations.metricEntities': '实体',
  'entityAssociations.metricPairs': '关联',
  'entityAssociations.rankedHeading': '最强关联',
  'entityAssociations.linkedBadge': '已关联',
  'entityAssociations.inferredBadge': '推断',
  ...
  'memoryFreshness.retry': '重试',
  'memoryFreshness.empty': '尚无知识图谱。',
  'memoryFreshness.emptyHint': '当助手记录关于您的事实时，其新鲜度将在此跟踪。',
  'memoryFreshness.namespaceLabel': '命名空间',
  'memoryFreshness.namespaceAll': '所有命名空间',
  'memoryFreshness.metricFresh': '新鲜',
  'memoryFreshness.metricFading': '衰减中',
  'memoryFreshness.metricStale': '过期',
  ...
  'memoryFreshness.statusFading': '衰减中',
  'memoryFreshness.statusStale': '过期',
  ...
  'onboarding.finishDesc': '一切就绪！开始使用 小鹈鹕。',
  'onboarding.skip': '跳过',
  'onboarding.getStarted': '开始使用',
  'onboarding.runtimeChoice.title': '你希望如何运行 小鹈鹕？',
  'onboarding.runtimeChoice.subtitle': '选择最适合你的设置。之后可在设置中更改。',
  'onboarding.runtimeChoice.cloud.title': '简单模式',
  'onboarding.runtimeChoice.cloud.tagline': '让 小鹈鹕 为你管理一切。',
  ...
  'onboarding.custom.defaultSubtitle': '让 小鹈鹕 为你管理。',
  ...
  'onboarding.custom.inference.defaultDesc':
    '小鹈鹕 会为每种工作负载路由到合适的默认模型。无需密钥，无需设置。',
  ...
  'onboarding.custom.voice.defaultDesc': '小鹈鹕 内置托管的 STT/TTS，开箱即用。无需额外配置。',
  ...
  'onboarding.custom.oauth.defaultDesc':
    '小鹈鹕 使用托管的 Composio 工作区。之后每个服务都可一键连接。',
  'onboarding.custom.oauth.configureDesc':
    '使用你自己的 Composio 账户或 API 密钥。在设置 › 连接中配置。',
  'onboarding.custom.search.title': '网页搜索',
  'onboarding.custom.search.subtitle': '小鹈鹕 如何代表你搜索网页。',
  'onboarding.custom.search.defaultDesc': '小鹈鹕 使用托管搜索后端。无需密钥。',
  'onboarding.custom.search.configureDesc':
    '使用你自己的搜索提供商密钥（Tavily、Brave 等）。在设置 › 工具中配置。',
  'onboarding.custom.embeddings.title': 'Embeddings',
  'onboarding.custom.embeddings.subtitle': '小鹈鹕 生成向量嵌入以实现语义记忆搜索的方式。',
  'onboarding.custom.embeddings.defaultDesc': '小鹈鹕 使用托管嵌入服务，无需 API 密钥。',
  'onboarding.custom.embeddings.configureDesc':
    '使用您自己的嵌入服务提供商（OpenAI、Voyage、Ollama 等）。',
  'onboarding.custom.memory.title': '记忆',
  'onboarding.custom.memory.subtitle': '小鹈鹕 如何记住你的上下文、偏好和历史对话。',
  'onboarding.custom.memory.defaultDesc': '小鹈鹕 会自动管理记忆存储和检索。无需设置。',
  ...
  'privacy.shareAnonymizedDataDesc':
    '通过分享受隐私限制的崩溃报告和使用事件来帮助改进 小鹈鹕，其中包括稳定的账号 ID 和应用版本元数据。我们绝不会收集消息、钱包密钥、API 密钥或会话令牌。',
  'privacy.meetingFollowUps': '会议跟进',
  'privacy.autoHandoffMeet': '自动将 Google Meet 转录交给编排器',
  'privacy.autoHandoffMeetDesc':
    '当 Google Meet 通话结束时，小鹈鹕 的编排器可以阅读转录内容，并可能执行起草消息、安排跟进、或将摘要发布到已连接的 Slack 工作区等操作。默认关闭。',
  ...
  'settings.about.starCta.title': '喜欢 小鹈鹕 吗？',
  ...
  'settings.search.menuDesc': '默认使用 小鹈鹕 托管搜索，或用 API 密钥接入你自己的提供商。',
  'settings.search.description':
    '选择智能体使用的搜索引擎。托管模式使用 小鹈鹕 后端（无需设置）。Parallel、Brave、Querit 和 Exa 会用你的 API 密钥从本机直接调用。',
  'settings.search.engineAria': '搜索引擎',
  'settings.search.engineDisabledLabel': '已禁用',
  'settings.search.engineDisabledDesc': '从智能体上下文和可用工具列表中移除搜索工具。',
  'settings.search.engineManagedLabel': '小鹈鹕 托管',
  'settings.search.engineManagedDesc':
    '默认选项。通过 小鹈鹕 后端路由，当前由 Exa 提供支持，无需 API 密钥。',
  'settings.search.localManagedUnavailable':
    '本地用户无法使用 小鹈鹕 托管搜索。请添加你自己的 Parallel、Brave、Querit 或 Exa API 密钥以启用网页搜索。',
  'settings.search.engineParallelLabel': '并行',
  ...
  'settings.embeddings.requiresSignIn': '需要登录 小鹈鹕',
  'settings.embeddings.managedLoginRequired':
    '托管嵌入需要登录 小鹈鹕。请登录后使用 小鹈鹕 后端。',
  'settings.embeddings.managedBannerIntro':
    '托管嵌入会通过 小鹈鹕 后端，并且需要 小鹈鹕 账号会话。',
  ...
  'settings.embeddings.managedBannerRemoteSession':
    '重新登录以刷新 小鹈鹕 会话，或切换到本地/自带密钥的嵌入提供商。',
  ...
  'devices.pairModal.instructions': '打开 iPhone 上的 小鹈鹕 应用程序并扫描此代码。',
  ...
  'mcp.connectAuth.oauthHint': '此服务器使用 OAuth。请通过浏览器登录以授权 小鹈鹕。',
  ...
  'autonomy.maxActionsHelp':
    '智能体每滚动小时内可执行的最大工具操作次数。新值将在下次对话时生效。定时任务和频道监听器将保持当前限制，直到重启 小鹈鹕。',
  ...
  'settings.tools.chooseCapabilities': '选择 小鹈鹕 可代表你使用的能力。',
  ...
  'voice.providers.chip.cloud': '小鹈鹕（托管）',
  'voice.providers.chip.cloudAria': '小鹈鹕 托管服务商始终启用',
  ...
  'voice.externalProviders.test': '测试',
  'voice.externalProviders.testing': '测试中…',
  'voice.externalProviders.remove': '移除',
  ...
  'voice.externalProviders.add': '添加',
  'pttSettings.title': '按住说话',
  'pttSettings.description':
    '在其他应用中时，按住按键即可与 小鹈鹕 对话。松开按键发送录音；若已开启「朗读回复」，小鹈鹕 会用语音读出回复。',
  ...
  'pttSettings.errorAccessibility':
    '此快捷键需要 macOS 的辅助功能权限。请打开系统设置 → 隐私与安全 → 辅助功能，并启用 小鹈鹕。',
  'pttSettings.errorShortcutInUse': '该快捷键已被其他应用占用。请选择其他快捷键。',
  'pttSettings.errorUnsupportedWayland':
    'Wayland 会话尚不支持 小鹈鹕 的全局快捷键：请切换到 X11 会话，或使用应用内的听写开关。',
  ...
  'chat.attachment.imageNotSupported':
    '此模型无法读取图像。您可以使用 小鹈鹕 推理层级来附加您的图像。',
  ...
  'bootCheck.desktopDescription': '小鹈鹕 需要一个运行中的核心才能工作。请选择连接方式。',
  'bootCheck.webDescription':
    '网页版 小鹈鹕 连接到由你控制的远程核心。请输入其 URL 和认证令牌，或安装桌面版在本地运行核心。',
  ...
  'bootCheck.legacyDescription':
    '此设备上正在运行一个单独安装的 小鹈鹕 守护进程。必须先将其移除，嵌入式核心才能接管。',
  ...
  'welcome.gatewaySessionErrorFallback':
    '目前无法完成登录。会话存储未及时响应（即使重试后也是如此）。请重新启动 小鹈鹕 并重试。',
  ...
  'composio.expiredDescription':
    '重新连接以重新启用 {name} 工具。 小鹈鹕 将保持此集成不可用，直到您刷新 OAuth 访问权限。',
  ...
  'mic.voiceNotCompiled': '此版本的应用未包含语音转文字功能。请更新 小鹈鹕 后再使用。',
  ...
  'app.connectionIndicator.connected': '已连接到 小鹈鹕 AI',
  ...
  'app.openhumanLink.notifications.permissionOff':
    '通知权限已关闭。请在“系统设置 → 通知”中启用 小鹈鹕，然后重试。',
  'app.openhumanLink.notifications.triggerFailed':
    '小鹈鹕 无法触发系统通知。请检查操作系统的通知设置，然后重试。',
  'app.openhumanLink.notifications.welcomeBody': '当有事情需要您关注时，您将在此处收到提醒。',
  'app.openhumanLink.notifications.welcomeTitle': '小鹈鹕 已准备就绪',
  ...
  'app.openhumanLink.notifications.blockedStep2': '找到 小鹈鹕',
  ...
  'app.openhumanLink.notifications.sent':
    '测试通知已发送。如果未收到，请前往「系统设置 → 通知 → 小鹈鹕」，开启「允许通知」并将横幅样式设置为「持续」。',
  ...
  'app.routeLoading.initializing': '正在初始化 小鹈鹕...',
  ...
  'channels.authMode.managed_dm': '使用 小鹈鹕 登录',
  ...
  'channels.discord.authMode.oauth.description':
    '通过 OAuth 将 小鹈鹕 机器人安装到你的 Discord 服务器。',
  'channels.discord.authMode.managed_dm.description':
    '将你的个人 Discord 账户关联到 小鹈鹕 机器人。',
  ...
  'channels.telegram.authMode.managed_dm.description': '直接向 小鹈鹕 Telegram 机器人发送消息。',
  ...
  // 微信 (iLink)
  'channels.wechat.displayName': '微信 (个人微信)',
  'channels.wechat.description': '通过腾讯官方 iLink 协议收发个人微信消息。',
  'channels.wechat.loginTitle': '扫码登录微信',
  'channels.wechat.loginBody':
    '使用手机微信扫描二维码，确认后会自动保存 bot_token 并连接 iLink 通道。',
  'channels.wechat.connected': '微信已连接',
  'channels.wechat.connectedHint':
    '个人微信消息会通过 iLink 通道收发。如需更换账号，请先断开再重新扫码。',
  'channels.wechat.startLogin': '扫码登录微信',
  'channels.wechat.qrAlt': '微信登录二维码',
  'channels.wechat.qrMissing': '二维码生成中…',
  'channels.wechat.verifyCodeLabel': '手机微信上显示的验证码',
  'channels.wechat.verifyCodePlaceholder': '例如 123456',
  'channels.wechat.submitVerifyCode': '提交验证码',
  'channels.wechat.waitingVerify': '等待验证码确认…',
  'channels.wechat.waitingScan': '等待手机微信扫码…',
  'channels.wechat.verifyCodeRequired': '请输入手机微信上显示的验证码',
  'channels.wechat.verifyCodeInvalid': '验证码不正确，请重试。',
  'channels.wechat.loginFailed': '微信登录失败，请重试。',
  'channels.wechat.restartRequired': '登录成功，但重启核心失败，请手动重启后再使用。',
  'channels.connectHelp.title': '如何连接',
  'channels.connectHelp.discord':
    '在下方选择一种方式：通过 小鹈鹕 关联你的账号、用 OAuth 安装机器人，或粘贴你在 Discord 开发者门户中的机器人令牌。',
  'channels.connectHelp.telegram':
    '在下方选择一种方式：给托管的 小鹈鹕 机器人发消息以完成关联，或粘贴你在 @BotFather 获取的机器人令牌。',
  'channels.connectHelp.wechat': '使用手机微信扫描二维码，通过官方 iLink 协议关联你的个人微信。',
  ...
  'composio.connect.permissionsNoteSuffix':
    '小鹈鹕 自身的智能体权限通过下方的读取、写入和管理员开关控制。',
  ...
  'composio.triggers.sessionExpired': '你的 小鹈鹕 会话已过期。请重新登录以加载触发器。',
  ...
  'daemon.serviceBlockingGate.title': '小鹈鹕 核心不可用',
  ...
  'intelligence.diagram.imageAlt': '最新生成的 小鹈鹕 架构图',
  ...
  'flows.nodeSummary.toolCall.pickNative': '运行一个 小鹈鹕 工具（请选择一个）',
  ...
  'rewards.community.activityStreakHint': '你在 小鹈鹕 连续活跃的天数。',
  ...
  'rewards.community.roleClaimDesc':
    '你已解锁 Discord 身份组，但尚未加入 小鹈鹕 服务器。加入后将自动为你分配。',
  ...
  'settings.ai.providers.managedDetail': '小鹈鹕 会为每项任务选择模型',
  ...
  'settings.ai.openhumanDefault': '小鹈鹕（默认）',
  ...
  'settings.ai.managedSourceLabel': '由 小鹈鹕 管理',
  ...
  'settings.ai.routing.managedDesc':
    '小鹈鹕 会在云端运行所有推理，为任务选择最佳模型，优化成本，并保持最安全的路由默认值。',
  'settings.ai.routing.managedMsg':
    '小鹈鹕 会处理每个工作负载的全部推理，并自动选择兼顾成本、质量和安全性的最佳路线。',
  ...
  'settings.ai.routing.workload.chat.label': '对话',
  ...
  'settings.ai.routing.workload.reasoning.label': '推理',
  ...
  'settings.ai.routing.workload.agentic.label': '智能体',
  ...
  'settings.ai.routing.workload.coding.label': '编程',
  ...
  'settings.ai.routing.workload.vision.label': '视觉',
  ...
  'settings.ai.routing.workload.heartbeat.label': '心跳',
  ...
  'settings.ai.routing.workload.subconscious.label': '潜意识',
  ...
  'settings.composio.confirmWarning':
    '你现有的集成（通过 小鹈鹕 关联的 Gmail、Slack、GitHub 等）将不可见：它们存放在 小鹈鹕 托管的 Composio 租户中。',
  ...
  'settings.composio.modeManaged': '托管（由 小鹈鹕 管理）',
  'settings.composio.modeManagedDesc':
    '小鹈鹕 通过我们的后端代理工具调用（推荐）。认证由我们处理，你无需粘贴 Composio API 密钥。Webhook 完全路由。',
  ...
  'settings.developerMenu.tools.desc': '启用或停用 小鹈鹕 可代表你使用的能力',
  ...
  'settings.developerMenu.mcpServer.desc': '配置外部 MCP 客户端以连接到 小鹈鹕',
  ...
  'settings.mcpServer.binaryPathNotFound':
    '未找到 小鹈鹕 二进制文件。如果使用源码运行，请执行：cargo build --bin openhuman-core',
  ...
  'settings.agentAccess.tinyplaceAutopilot.desc':
    '让 小鹈鹕 自行在 tiny.place 上行动：按计划寻找有价值的工作（优先开放的悬赏），完成符合其技能的任务，并以你的身份行动。它在无人监督下运行且可以花费资金，测试时请使用 devnet。默认关闭。',
  ...
  'settings.mascot.characterDesc': '选择你的 小鹈鹕 角色',
  ...
  'settings.mascot.colorAria': '小鹈鹕 颜色',
  ...
  'settings.memoryWindow.description':
    '小鹈鹕 在每次新的智能体运行中注入多少记忆上下文。更大的窗口对过往对话更有感知，但每次运行会消耗更多 token，成本也更高。',
  ...
  'skills.meetingBots.bannerDesc': '让 小鹈鹕 加入你的会议，自动记录摘要',
  'skills.meetingBots.bannerTitle': '会议机器人',
  'skills.meetingBots.busyTitle': '小鹈鹕 正忙',
  'skills.meetingBots.comingSoon': '即将推出',
  'skills.meetingBots.couldNotLeaveTitle': '无法离开会议',
  'skills.meetingBots.couldNotStartTitle': '无法启动 小鹈鹕',
  'skills.meetingBots.displayName': '显示名称',
  'skills.meetingBots.failedToStart': '启动 小鹈鹕 失败。',
  'skills.meetingBots.joiningMessage': '它应该在几秒钟内作为参会者出现。',
  'skills.meetingBots.joiningTitle': '小鹈鹕 正在加入会议',
  'skills.meetingBots.meetingLink': '会议链接',
  'skills.meetingBots.modalAriaLabel': '将 小鹈鹕 发送到会议',
  'skills.meetingBots.modalDesc': '输入会议链接，让 小鹈鹕 作为参会者加入并记录内容。',
  'skills.meetingBots.modalTitle': '将 小鹈鹕 发送到会议',
  ...
  'skills.meetingBots.serverOverloaded': '小鹈鹕 当前负载过高，请几分钟后重试。',
  ...
  'skills.meetingBots.history.runWith小鹈鹕': '使用 小鹈鹕 运行',
  ...
  'skills.meetingBots.defaults.watchCalendarDesc':
    '让 小鹈鹕 监控您连接的日历，以便根据以下策略自动加入会议或提示参加会议。这与会议提醒通知是分开的。',
  ...
  'walkthrough.steps.brainTab.content':
    'Brain 是记忆图谱，用来查看 小鹈鹕 知道什么，以及想法如何相互连接。',
  ...
  'settings.mascot.noCharactersAvailable': '暂无可用的 小鹈鹕 角色',
  ...
  'devOptions.menuToolsDesc': '启用或禁用 小鹈鹕 可代表你使用的能力',
  ...
  'harnessInit.subtitle': '小鹈鹕 正在准备首次启动所需的组件。',
  ...
  'harnessInit.failedMessage':
    '部分设置步骤未完成。你可以重试或继续：小鹈鹕 将使用内置的后备方案。',
  'harnessInit.retry': '重试',
  'harnessInit.continueAnyway': '仍然继续',
  'harnessInit.runInBackground': '在后台运行',
  'harnessInit.backgroundHint': '在此完成期间，你可以继续使用 小鹈鹕。',

  'keyring.consent.title': '安全存储不可用',
  'keyring.consent.description':
    '您的操作系统密钥链不可访问。小鹈鹕 需要您的许可，以便使用本地加密存储来保存密钥。',
  ...
  'memory.health.remediation.auth_missing':
    '未找到嵌入凭据。请登录 小鹈鹕，或在连接 → API 密钥 → 向量嵌入 中设置本地 Ollama 嵌入。',
  ...
  'memory.health.remediation.storage_unavailable':
    '小鹈鹕 无法写入其记忆存储：磁盘或 SD 卡似乎已损坏、已满或为只读。请检查驱动器并释放空间；存储恢复可写后，记忆处理将自动继续。',
  ...
  'onboarding.custom.vault.defaultDesc':
    '使用 小鹈鹕 托管的记忆默认设置。保险库路径和同步健康状态仍可稍后查看。',
  'onboarding.custom.vault.configureDesc': '立即查看保险库所有权、运行健康检查并调整记忆控制。',
  'onboarding.custom.vault.localDisabledReason': '托管设置需要登录 小鹈鹕，在本地模式下不可用。',
  ...
  'vaultHealth.writableLabel': '小鹈鹕 可写入保险库',
  'vaultHealth.writableRecovery': '小鹈鹕 暂时无法写入此保险库。请授予写入权限后刷新。',
  ...
  'memoryData.workspaceVaultDesc': '小鹈鹕 将生成的记忆笔记写入 memory_tree/content。',
  ...
  'memoryData.internalFilesDesc':
    '索引、队列状态和摘要由 小鹈鹕 管理，以保持召回和同步的正常运行。',
  ...
  'settings.gateway.description':
    '内核可以在容器中运行，也可以通过 SSH 在另一台机器上运行，或者在另一台机器的容器中运行。小鹈鹕 会启动它、连接它，并在你切换到别处时把它关闭。',
