...
const messages: TranslationMap = {
  ...
  'share.defaultHeadline': 'Regardez ce que mon agent 小鹈鹕 vient de faire',
  'share.defaultAgentName': 'Mon agent',
  'share.defaultCaption': 'Regardez ce que mon agent 小鹈鹕 vient de faire.',
  'share.captionWithHeadline': '{headline}. Réalisé avec mon agent 小鹈鹕.',
  ...
  'feedback.welcome.body':
    'Dites-nous ce qui fonctionne, ce qui manque et ce qui rendrait 小鹈鹕 meilleur. Proposez une idée, votez pour celles des autres et regardez les meilleures remonter en tête de notre feuille de route.',
  ...
  'rewards.welcome.body':
    'Gagnez des points à mesure que vous utilisez 小鹈鹕 et invitez d’autres personnes, maintenez votre série en vie et échangez ce que vous avez gagné, le tout suivi au même endroit.',
  ...
  'settings.core.applyRestartNote': 'Enregistrer redémarre 小鹈鹕 pour se reconnecter.',
  ...
  'conversations.toolFailure.missingPermission.cause':
    "小鹈鹕 n'a pas encore l'autorisation de faire cela.",
  ...
  'conversations.toolFailure.serviceUnavailable.cause':
    'Un service dont 小鹈鹕 a besoin est temporairement indisponible.',
  'conversations.toolFailure.serviceUnavailable.next':
    '小鹈鹕 réessaiera bientôt: aucune action nécessaire.',
  ...
  'conversations.toolFailure.modelConnection.cause': "小鹈鹕 n'a pas pu joindre le modèle d'IA.",
  'conversations.toolFailure.modelConnection.next':
    'Vérifiez votre connexion ou les paramètres du modèle ; 小鹈鹕 réessaiera.',
  ...
  'conversations.toolFailure.timeout.next':
    "小鹈鹕 réessaiera, ou vous pouvez relancer l'action manuellement.",
  ...
  'conversations.toolFailure.approvalExpired.next':
    "Redemandez pour l'exécuter: 小鹈鹕 ne réessaiera pas tout seul.",
  ...
  'orchPage.medulla.tagline': "Le modèle d'orchestration d'小鹈鹕",
  'orchPage.medulla.body':
    "Medulla est le LLM développé sur mesure par 小鹈鹕, conçu pour orchestrer des milliers d'agents à la fois, avec une fenêtre de contexte de 10 millions de tokens et une orchestration à coût radicalement bas.",
  ...
  'orchPage.medulla.subscriberTitle': 'Abonnés 小鹈鹕',
  'orchPage.medulla.subscriberNote':
    'Au lancement de Medulla, il sera exclusivement réservé aux abonnés 小鹈鹕.',
  ...
  'orchPage.connections.initDesc':
    "Lancez un nouveau sous-agent pour travailler à vos côtés. Ouvrez le chat de l'agent et décrivez son rôle, son objectif et ses outils: 小鹈鹕 provisionne une instance dédiée que vous pilotez d'ici.",
  ...
  'tinyplaceOrchestration.master.preview': 'Coordination directe entre vous et 小鹈鹕.',
  ...
  'tinyplaceOrchestration.composer.placeholder': 'Message à 小鹈鹕…',
  ...
  'welcome.logoAlt': '小鹈鹕',
  'welcome.title': 'Bienvenue sur 小鹈鹕',
  'welcome.subtitle':
  ...
  'welcome.resetErrorFallback':
    "Impossible d'effacer les données de l'appli. Quittez et rouvrez 小鹈鹕, puis réessayez.",
  ...
  'home.statusCoreUnreachable':
    "Le processus local 小鹈鹕 ne répond pas. Il a peut-être planté ou n'a pas démarré correctement.",
  ...
  'rewards.localUnavailable':
    'La connexion locale ne permet pas de gagner des récompenses, des coupons ou du crédit de parrainage. Déconnecte-toi puis connecte-toi avec un compte 小鹈鹕 si tu veux que les récompenses comptent.',
  ...
  'onboarding.welcome': 'Salut. Je suis 小鹈鹕.',
  ...
  'onboarding.finishDesc': 'Tout est prêt ! Commence à utiliser 小鹈鹕.',
  'onboarding.skip': 'Passer',
  'onboarding.getStarted': 'Démarrer',
  'onboarding.runtimeChoice.title': 'Comment veux-tu utiliser 小鹈鹕 ?',
  ...
  'onboarding.runtimeChoice.cloud.tagline': 'Laisse 小鹈鹕 tout gérer pour toi.',
  ...
  'onboarding.custom.defaultSubtitle': 'Laisse 小鹈鹕 gérer ça pour toi.',
  ...
  'onboarding.custom.inference.defaultDesc':
    '小鹈鹕 dirige chaque charge de travail vers un modèle par défaut adapté. Aucune clé, aucune configuration.',
  ...
  'onboarding.custom.voice.defaultDesc':
    '小鹈鹕 inclut un STT/TTS géré qui fonctionne directement. Rien à configurer.',
  ...
  'onboarding.custom.oauth.defaultDesc':
    '小鹈鹕 gère un espace de travail Composio. Un clic pour connecter chaque service plus tard.',
  ...
  'onboarding.custom.search.subtitle':
    'Comment 小鹈鹕 effectue des recherches sur le web en ton nom.',
  'onboarding.custom.search.defaultDesc':
    '小鹈鹕 utilise un backend de recherche géré. Aucune clé nécessaire.',
  ...
  'onboarding.custom.embeddings.subtitle':
    'Comment 小鹈鹕 génère des embeddings vectoriels pour la recherche sémantique en mémoire.',
  'onboarding.custom.embeddings.defaultDesc':
    "小鹈鹕 utilise un service d'embedding géré. Aucune clé API requise.",
  ...
  'onboarding.custom.memory.subtitle':
    'Comment 小鹈鹕 mémorise ton contexte, tes préférences et tes conversations passées.',
  'onboarding.custom.memory.defaultDesc':
    '小鹈鹕 gère automatiquement le stockage et la récupération en mémoire. Rien à configurer.',
  ...
  'misc.beta':
    "小鹈鹕 est en bêta anticipée. N'hésite pas à partager tes retours ou signaler des bugs: chaque rapport nous aide à avancer plus vite.",
  ...
  'privacy.shareAnonymizedDataDesc':
    "Aide à améliorer 小鹈鹕 en partageant des rapports de plantage et des événements d'utilisation limités pour la confidentialité, incluant un ID de compte stable et les métadonnées de version de l'app. Les messages, clés de portefeuille, clés API et jetons de session ne sont jamais collectés.",
  ...
  'privacy.autoHandoffMeetDesc':
    "Quand un appel Google Meet se termine, l'orchestrateur d'小鹈鹕 peut lire la transcription et effectuer des actions comme rédiger des messages, planifier des suivis ou publier des résumés sur ton espace Slack connecté. Désactivé par défaut.",
  ...
  'settings.about.starCta.title': '小鹈鹕 vous plaît ?',
  ...
  'settings.search.menuDesc':
    'Par défaut, utilisez la recherche gérée par 小鹈鹕 ou connectez votre propre fournisseur avec une clé API.',
  'settings.search.description':
    "Choisissez le moteur de recherche utilisé par l'agent, ou désactivez entièrement les outils de recherche. Géré utilise le backend d'小鹈鹕 (sans configuration). Parallel, Brave, Querit et Exa s'exécutent directement depuis votre machine avec votre clé API.",
  ...
  'settings.search.engineManagedLabel': '小鹈鹕 Géré',
  'settings.search.engineManagedDesc':
    'Par défaut. Acheminé via le backend 小鹈鹕, actuellement propulsé par Exa: aucune clé API requise.',
  'settings.search.localManagedUnavailable':
    'La recherche gérée par 小鹈鹕 n’est pas disponible pour les utilisateurs locaux. Ajoutez votre propre clé API Parallel, Brave, Querit ou Exa pour activer la recherche web.',
  ...
  'settings.embeddings.requiresSignIn': 'Connexion 小鹈鹕 requise',
  'settings.embeddings.managedLoginRequired':
    'Les embeddings gérés nécessitent une connexion 小鹈鹕. Connectez-vous pour utiliser le backend 小鹈鹕.',
  'settings.embeddings.managedBannerIntro':
    'Les embeddings gérés passent par le backend 小鹈鹕 et nécessitent une session de compte 小鹈鹕.',
  ...
  'settings.embeddings.managedBannerRemoteSession':
    'Reconnectez-vous pour actualiser votre session 小鹈鹕, ou passez à un fournisseur local ou avec votre propre clé.',
  ...
  'devices.betaText':
    'Cette fonctionnalité est actuellement en bêta. Associez des iPhone à cet 小鹈鹕 pour les utiliser comme client distant.',
  ...
  'devices.emptyState':
    'Scannez un code QR sur votre iPhone pour le connecter à cette session 小鹈鹕.',
  ...
  'devices.pairModal.instructions':
    'Ouvrez l’application 小鹈鹕 sur votre iPhone et scannez ce code.',
  ...
  'mcp.connectAuth.oauthHint':
    'Ce serveur utilise OAuth. Connectez-vous via votre navigateur pour autoriser 小鹈鹕.',
  ...
  'autonomy.maxActionsHelp':
    "Nombre maximum d'actions d'outil qu'un agent peut exécuter par heure glissante. La nouvelle valeur s'applique à votre prochaine conversation. Les tâches planifiées et les écouteurs de canaux conservent leur limite actuelle jusqu'au redémarrage d'小鹈鹕.",
  ...
  'settings.tools.chooseCapabilities':
    "Choisis les fonctionnalités qu'小鹈鹕 peut utiliser en ton nom.",
  ...
  'voice.providers.chip.cloud': '小鹈鹕 (Géré)',
  'voice.providers.chip.cloudAria': 'Le fournisseur géré 小鹈鹕 est toujours activé',
  ...
  'pttSettings.description':
    'Maintiens une touche pour parler à 小鹈鹕 pendant que tu utilises une autre application. Relâcher envoie l’enregistrement ; si « Lire les réponses » est activé, 小鹈鹕 lit la réponse à voix haute.',
  ...
  'pttSettings.errorAccessibility':
    'macOS exige l’autorisation Accessibilité pour ce raccourci. Ouvre Réglages système → Confidentialité et sécurité → Accessibilité et active 小鹈鹕.',
  ...
  'pttSettings.errorUnsupportedWayland':
    'Les sessions Wayland ne prennent pas encore en charge les raccourcis globaux dans 小鹈鹕: passe à une session X11 ou utilise la commande de dictée intégrée à l’application.',
  ...
  'chat.attachment.videoNotSupported':
    'Ce modèle ne peut pas lire les vidéos. Tu peux utiliser le niveau Raisonnement d’小鹈鹕 pour joindre ta vidéo.',
  ...
  'chat.attachment.imageNotSupported':
    'Ce modèle ne peut pas lire les images. Tu peux utiliser le niveau Raisonnement d’小鹈鹕 pour joindre ton image.',
  ...
  'bootCheck.desktopDescription':
    "小鹈鹕 a besoin d'un runtime pour fonctionner. Choisis où il doit être hébergé.",
  'bootCheck.webDescription':
    "Sur le web, 小鹈鹕 se connecte à un runtime que tu contrôles. Renseigne son URL et son token d'authentification ci-dessous, ou télécharge l'app desktop pour en faire tourner un directement sur ta machine.",
  ...
  'bootCheck.legacyDescription':
    "Un daemon 小鹈鹕 installé séparément est déjà en cours d'exécution sur cet appareil. On doit le supprimer avant que le runtime intégré puisse prendre le relais.",
  ...
  'bootCheck.portConflictBody':
    'Un autre processus utilise le port réseau dont 小鹈鹕 a besoin. Nous allons tenter de corriger cela automatiquement.',
  ...
  'bootCheck.portConflictOwner':
    '{name} (PID {pid}) utilise le port réseau dont 小鹈鹕 a besoin.',
  ...
  'welcome.gatewaySessionErrorFallback':
    'La connexion n’a pas pu être terminée pour le moment. Le stockage de session n’a pas répondu à temps (même après plusieurs tentatives). Redémarrez 小鹈鹕 et réessayez.',
  ...
  'composio.expiredDescription':
    "Reconnectez-vous pour réactiver les outils {name}. 小鹈鹕 gardera cette intégration indisponible jusqu'à ce que vous actualisiez l'accès OAuth.",
  ...
  'mic.voiceNotCompiled':
    "La transcription vocale n'est pas incluse dans cette version de l'application. Mettez à jour 小鹈鹕 pour l'activer.",
  ...
  'app.connectionIndicator.connected': 'Connecté à 小鹈鹕 AI 🚀',
  ...
  'app.openhumanLink.notifications.permissionOff':
    "L'autorisation des notifications est désactivée. Activez 小鹈鹕 dans Réglages système → Notifications, puis réessayez.",
  'app.openhumanLink.notifications.triggerFailed':
    "小鹈鹕 n'a pas pu déclencher de notification système. Vérifiez les paramètres de notification du système d'exploitation et réessayez.",
  'app.openhumanLink.notifications.welcomeBody':
    "Vous recevrez des alertes ici lorsqu'une chose nécessitera votre attention.",
  'app.openhumanLink.notifications.welcomeTitle': '小鹈鹕 est prêt',
  ...
  'app.openhumanLink.notifications.sent':
    "Notification de test envoyée. Si vous ne l'avez pas reçue, allez dans Réglages Système → Notifications → 小鹈鹕, activez Autoriser les notifications, et définissez le style de bannière sur Persistant.",
  ...
  'app.routeLoading.initializing': "Initialisation d'小鹈鹕...",
  ...
  'channels.authMode.managed_dm': 'Connectez-vous avec 小鹈鹕',
  ...
  'channels.discord.authMode.oauth.description':
    'Installez le bot 小鹈鹕 sur votre serveur Discord via OAuth.',
  'channels.discord.authMode.managed_dm.description':
    'Liez votre compte personnel Discord au bot 小鹈鹕.',
  ...
  'channels.telegram.authMode.managed_dm.description':
    'Envoyez un message directement au robot 小鹈鹕 Telegram.',
  ...
  'channels.connectHelp.discord':
    'Choisissez une méthode ci-dessous : reliez votre compte via 小鹈鹕, installez le bot avec OAuth, ou collez votre propre jeton de bot depuis le portail développeur Discord.',
  'channels.connectHelp.telegram':
    'Choisissez une méthode ci-dessous : écrivez au bot 小鹈鹕 géré pour le relier, ou collez votre propre jeton de bot depuis @BotFather.',
  ...
  'iosPair.error.invalidQr':
    "Code QR invalide. Assurez-vous de scanner un code d'association 小鹈鹕.",
  ...
  'iosPair.instructions':
    'Ouvrez 小鹈鹕 sur votre bureau, allez dans Réglages > Appareils et appuyez sur « Associer un téléphone » pour afficher le code QR.',
  'iosPair.retryScan': 'Rescanner',
  'iosPair.scanQrCode': 'Numérisation QR code',
  'iosPair.scannerOpening': 'Ouverture du scanner...',
  'iosPair.step.openDesktop': 'Ouvrez 小鹈鹕 sur le bureau',
  ...
  'composio.connect.permissionsNoteSuffix':
    "Les autorisations de l'agent 小鹈鹕 sont contrôlées ci-dessous par des bascules lecture, écriture et admin.",
  ...
  'composio.triggers.sessionExpired':
    'Votre session 小鹈鹕 a expiré. Reconnectez-vous pour charger les déclencheurs.',
  ...
  'daemon.serviceBlockingGate.title': 'Le core 小鹈鹕 est indisponible',
  ...
  'intelligence.diagram.imageAlt': "Dernier diagramme d'architecture 小鹈鹕 généré",
  ...
  'flows.nodeSummary.toolCall.pickNative': 'Exécute un outil 小鹈鹕 (à choisir)',
  ...
  'rewards.community.activityStreakHint': 'Jours consécutifs d’activité sur 小鹈鹕.',
  ...
  'rewards.community.roleClaimDesc':
    "Vous avez débloqué des rôles Discord mais n'avez pas encore rejoint le serveur 小鹈鹕. Rejoignez-le pour qu'ils soient attribués automatiquement.",
  ...
  'settings.ai.providers.managedDetail': '小鹈鹕 choisit un modèle pour chaque tâche',
  ...
  'settings.ai.openhumanDefault': '小鹈鹕 (par défaut)',
  ...
  'settings.ai.managedSourceLabel': 'Géré par 小鹈鹕',
  ...
  'settings.ai.routing.managedDesc':
    '小鹈鹕 exécutera toutes les inférences dans le cloud, choisira le meilleur modèle pour la tâche, optimisera les coûts et conservera les paramètres de routage les plus sûrs par défaut.',
  'settings.ai.routing.managedMsg':
    '小鹈鹕 gérera toutes les inférences pour chaque charge de travail et choisira automatiquement la meilleure route en termes de coût, de qualité et de sécurité.',
  ...
  'settings.composio.confirmWarning':
    'Vos intégrations existantes (Gmail, Slack, GitHub, etc. liées via 小鹈鹕) ne seront pas visibles: elles vivent dans le tenant Composio géré par 小鹈鹕.',
  ...
  'settings.composio.modeManaged': "Géré (小鹈鹕 s'en occupe pour toi)",
  'settings.composio.modeManagedDesc':
    "小鹈鹕 relaie les appels d'outils via notre backend (recommandé). L'authentification est négociée ; vous ne collez jamais de clé API Composio. Les webhooks sont entièrement routés.",
  ...
  'settings.developerMenu.tools.desc':
    "Active ou désactive les capacités qu'小鹈鹕 peut utiliser en ton nom",
  ...
  'settings.developerMenu.mcpServer.desc':
    'Configurer les clients MCP externes pour se connecter à 小鹈鹕',
  ...
  'settings.mcpServer.binaryPathNotFound':
    'Binaire 小鹈鹕 introuvable. Si vous exécutez à partir des sources, compilez avec : cargo build --bin openhuman-core',
  ...
  'settings.mascot.colorAria': '小鹈鹕 couleur',
  ...
  'settings.mascot.libraryUnavailable': '小鹈鹕 bibliothèque indisponible',
  'settings.mascot.title': '小鹈鹕',
  'settings.mascot.loadingLibrary': 'Chargement de la bibliothèque 小鹈鹕…',
  ...
  'settings.mascot.localDefault': '小鹈鹕 local (par défaut)',
  ...
  'settings.mascot.noCharacters': "Aucun personnage 小鹈鹕 n'est encore disponible",
  ...
  'settings.memoryWindow.description':
    "Quelle quantité de contexte mémorisé 小鹈鹕 injecte dans chaque nouvelle exécution d'agent. Des fenêtres plus larges semblent plus conscientes des conversations passées mais consomment plus de jetons (et coûtent plus cher) à chaque exécution.",
  ...
  'skills.meetingBots.serverOverloaded':
    '小鹈鹕 est actuellement très sollicité. Veuillez réessayer dans quelques minutes.',
  ...
  'skills.meetingBots.history.runWith小鹈鹕': 'Exécuter avec 小鹈鹕',
  ...
  'skills.meetingBots.defaults.watchCalendarDesc':
    "Laissez 小鹈鹕 surveiller votre agenda connecté pour qu'il puisse rejoindre automatiquement ou vous inviter à des réunions selon les politiques ci-dessous. Cela est indépendant des notifications de rappel de réunion.",
  ...
  'walkthrough.steps.brainTab.content':
    'Brain est le graphe de mémoire : l’endroit où vérifier ce qu’小鹈鹕 sait et comment les idées se relient.',
  ...
  'settings.mascot.noCharactersAvailable': "Aucun personnage 小鹈鹕 n'est encore disponible",
  ...
  'devOptions.menuToolsDesc':
    'Activer ou désactiver les fonctionnalités que 小鹈鹕 peut utiliser en votre nom',
  ...
  'harnessInit.subtitle':
    '小鹈鹕 prépare les composants dont il a besoin lors du premier lancement.',
  ...
  'harnessInit.failedMessage':
    'Certaines étapes de configuration ne se sont pas terminées. Vous pouvez réessayer ou continuer: 小鹈鹕 utilisera une solution de secours intégrée.',
  ...
  'harnessInit.backgroundHint':
    'Vous pouvez continuer à utiliser 小鹈鹕 pendant que cela se termine.',

  'keyring.consent.title': 'Stockage sécurisé indisponible',
  'keyring.consent.description':
    "Le trousseau de votre système d'exploitation n'est pas accessible. 小鹈鹕 a besoin de votre autorisation pour stocker les secrets en utilisant un stockage local chiffré.",
  ...
  'memory.health.remediation.auth_missing':
    "Aucune information d'identification d'embeddings trouvée. Connectez-vous à 小鹈鹕 ou configurez des embeddings Ollama locaux dans Connexions → Clés API → Intégrations.",
  ...
  'memory.health.remediation.storage_unavailable':
    "小鹈鹕 ne peut pas écrire dans son stockage de mémoire: le disque ou la carte SD semble défaillant, plein ou en lecture seule. Vérifiez le lecteur et libérez de l'espace ; le traitement de la mémoire reprendra automatiquement une fois le stockage de nouveau accessible en écriture.",
  ...
  'onboarding.custom.vault.defaultDesc':
    "Utiliser les paramètres de mémoire gérés par 小鹈鹕. Le chemin du coffre et l'état de synchronisation peuvent encore être consultés ultérieurement.",
  ...
  'onboarding.custom.vault.localDisabledReason':
    "La configuration gérée nécessite une connexion à 小鹈鹕 et n'est pas disponible en mode local.",
  ...
  'vaultHealth.writableLabel': 'Le coffre est accessible en écriture par 小鹈鹕',
  'vaultHealth.writableRecovery':
    "小鹈鹕 ne peut pas encore écrire dans ce coffre. Accordez les autorisations d'écriture et actualisez.",
  ...
  'memoryData.workspaceVaultDesc':
    '小鹈鹕 écrit les notes de mémoire générées dans memory_tree/content.',
  ...
  'memoryData.internalFilesDesc':
    "Les index, l'état de la file d'attente et les résumés sont gérés par 小鹈鹕 pour maintenir la mémoire et la synchronisation en bon état.",
  ...
  'settings.gateway.description':
    'Le cœur peut s’exécuter dans un conteneur, sur une autre machine via SSH, ou dans un conteneur sur une autre machine. 小鹈鹕 le démarre, s’y connecte et l’arrête quand vous changez d’emplacement.',
