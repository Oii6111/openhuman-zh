...
const messages: TranslationMap = {
  ...
  'share.defaultHeadline': 'Смотрите, что только что сделал мой агент 小鹈鹕',
  'share.defaultAgentName': 'Мой агент',
  'share.defaultCaption': 'Смотрите, что только что сделал мой агент 小鹈鹕.',
  'share.captionWithHeadline': '{headline}. Создано с помощью моего агента 小鹈鹕.',
  ...
  'feedback.welcome.body':
    'Расскажите нам, что работает, чего не хватает и что сделало бы 小鹈鹕 лучше. Опубликуйте идею, голосуйте за предложения других и наблюдайте, как лучшие поднимаются на вершину нашей дорожной карты.',
  ...
  'rewards.welcome.body':
    'Зарабатывайте баллы, пользуясь 小鹈鹕 и приглашая других, поддерживайте свою серию и обменивайте заработанное. Всё отслеживается в одном месте.',
  ...
  'settings.core.applyRestartNote':
    'После сохранения 小鹈鹕 перезапустится для повторного подключения.',
  ...
  'conversations.toolFailure.missingPermission.cause':
    'У 小鹈鹕 пока нет разрешения на это действие.',
  ...
  'conversations.toolFailure.serviceUnavailable.cause':
    'Служба, необходимая 小鹈鹕, временно недоступна.',
  'conversations.toolFailure.serviceUnavailable.next':
    '小鹈鹕 скоро повторит попытку: ничего делать не нужно.',
  ...
  'conversations.toolFailure.modelConnection.cause': '小鹈鹕 не удалось связаться с ИИ-моделью.',
  'conversations.toolFailure.modelConnection.next':
    'Проверьте подключение или настройки модели; 小鹈鹕 повторит попытку.',
  ...
  'conversations.toolFailure.timeout.next':
    '小鹈鹕 повторит попытку, или вы можете повторить её вручную.',
  ...
  'conversations.toolFailure.approvalExpired.next':
    'Попросите снова, чтобы выполнить его: 小鹈鹕 не повторит попытку сам.',
  ...
  'orchPage.medulla.tagline': 'Модель оркестрации 小鹈鹕',
  'orchPage.medulla.body':
    'Medulla представляет собой собственную большую языковую модель 小鹈鹕, спроектированную для оркестрации тысяч агентов одновременно, с окном контекста в 10 миллионов токенов и радикально низкой стоимостью оркестрации.',
  ...
  'orchPage.medulla.subscriberTitle': 'Подписчики 小鹈鹕',
  'orchPage.medulla.subscriberNote':
    'Когда Medulla выйдет, она будет доступна только подписчикам 小鹈鹕.',
  ...
  'orchPage.connections.initDesc':
    'Создайте нового субагента для работы рядом с вами. Откройте чат агента и опишите роль, цель и инструменты: 小鹈鹕 подготовит выделенный экземпляр, которым вы управляете отсюда.',
  ...
  'tinyplaceOrchestration.master.preview': 'Прямая координация между вами и 小鹈鹕.',
  ...
  'tinyplaceOrchestration.composer.placeholder': 'Сообщение для 小鹈鹕…',
  ...
  'welcome.logoAlt': '小鹈鹕',
  'welcome.title': 'Добро пожаловать в 小鹈鹕',
  ...
  'welcome.resetErrorFallback':
    'Не удалось очистить данные приложения. Закройте и снова откройте 小鹈鹕, затем повторите попытку.',
  ...
  'home.statusCoreUnreachable':
    'Локальный процесс 小鹈鹕 не отвечает. Возможно, он завис или не запустился.',
  ...
  'rewards.localUnavailable':
    'Локальный вход не приносит награды, купоны или реферальный кредит. Выйдите и войдите с аккаунтом 小鹈鹕, если хотите, чтобы награды начислялись.',
  ...
  'onboarding.welcome': 'Привет. Я 小鹈鹕.',
  ...
  'onboarding.finishDesc': 'Всё готово! Начни пользоваться 小鹈鹕.',
  'onboarding.skip': 'Пропустить',
  'onboarding.getStarted': 'Начать',
  'onboarding.runtimeChoice.title': 'Как ты хочешь запустить 小鹈鹕?',
  ...
  'onboarding.runtimeChoice.cloud.tagline': 'Пусть 小鹈鹕 сам обо всём позаботится.',
  ...
  'onboarding.custom.defaultSubtitle': 'Пусть 小鹈鹕 сам управляет этим.',
  ...
  'onboarding.custom.inference.defaultDesc':
    '小鹈鹕 автоматически выбирает подходящую модель. Без ключей и настроек.',
  ...
  'onboarding.custom.voice.defaultDesc':
    '小鹈鹕 поставляется с управляемым STT/TTS, который работает сразу. Ничего настраивать не нужно.',
  ...
  'onboarding.custom.oauth.defaultDesc':
    '小鹈鹕 использует управляемое рабочее пространство Composio. Один клик для подключения каждого сервиса.',
  ...
  'onboarding.custom.search.subtitle': 'Как 小鹈鹕 ищет информацию в интернете.',
  'onboarding.custom.search.defaultDesc':
    '小鹈鹕 использует управляемый поисковый бэкенд. Ключи не нужны.',
  'onboarding.custom.search.configureDesc':
    'Используй свой ключ поискового провайдера (Tavily, Brave и др.). Настрой в Настройки › Инструменты.',
  'onboarding.custom.embeddings.title': 'Embeddings',
  'onboarding.custom.embeddings.subtitle':
    'Как 小鹈鹕 создаёт векторные эмбеддинги для семантического поиска в памяти.',
  'onboarding.custom.embeddings.defaultDesc':
    '小鹈鹕 использует управляемый сервис эмбеддингов. API-ключ не требуется.',
  ...
  'onboarding.custom.memory.subtitle':
    'Как 小鹈鹕 запоминает контекст, предпочтения и предыдущие разговоры.',
  'onboarding.custom.memory.defaultDesc':
    '小鹈鹕 автоматически управляет хранением и извлечением воспоминаний. Ничего настраивать не нужно.',
  ...
  'misc.beta':
    '小鹈鹕 находится в стадии раннего бета-тестирования. Делись отзывами и сообщай об ошибках: каждый репорт помогает нам двигаться быстрее.',
  ...
  'privacy.shareAnonymizedDataDesc':
    'Помоги улучшить 小鹈鹕, отправляя ограниченные по приватности отчёты о сбоях и события использования, включая стабильный ID аккаунта и метаданные версии приложения. Сообщения, ключи кошелька, API-ключи и токены сессии никогда не собираются.',
  ...
  'privacy.autoHandoffMeetDesc':
    'Когда звонок в Google Meet заканчивается, оркестратор 小鹈鹕 может прочитать транскрипт и выполнить действия: составить сообщения, запланировать задачи или опубликовать итоги в Slack. По умолчанию выключено.',
  ...
  'settings.about.starCta.title': 'Нравится 小鹈鹕?',
  ...
  'settings.search.menuDesc':
    'По умолчанию используется поиск, управляемый 小鹈鹕, или подключите собственного провайдера с помощью ключа API.',
  'settings.search.description':
    'Выберите поисковую систему, которую использует агент, или полностью отключите инструменты поиска. Управляемый режим использует серверную часть 小鹈鹕 (настройка не требуется). Parallel, Brave, Querit и Exa работают напрямую с вашего устройства, используя ваш API-ключ.',
  ...
  'settings.search.engineManagedLabel': '小鹈鹕 Управляемый',
  'settings.search.engineManagedDesc':
    'По умолчанию. Маршрутизируется через серверную часть 小鹈鹕, сейчас на базе Exa: ключ API не требуется.',
  'settings.search.localManagedUnavailable':
    'Поиск 小鹈鹕 Managed недоступен для локальных пользователей. Добавьте свой ключ API Parallel, Brave, Querit или Exa, чтобы включить веб-поиск.',
  ...
  'settings.embeddings.requiresSignIn': 'Требуется вход в 小鹈鹕',
  'settings.embeddings.managedLoginRequired':
    'Для управляемых эмбеддингов требуется вход в 小鹈鹕. Войдите, чтобы использовать backend 小鹈鹕.',
  'settings.embeddings.managedBannerIntro':
    'Управляемые эмбеддинги проходят через backend 小鹈鹕 и требуют сеанс учетной записи 小鹈鹕.',
  ...
  'settings.embeddings.managedBannerRemoteSession':
    'Войдите снова, чтобы обновить сеанс 小鹈鹕, или переключитесь на локального провайдера эмбеддингов либо провайдера с собственным ключом.',
  ...
  'devices.betaText':
    'Эта функция находится в стадии бета-тестирования. Подключите iPhone к этому 小鹈鹕 для использования в качестве удалённого клиента.',
  ...
  'devices.emptyState':
    'Отсканируйте QR-код на своём iPhone, чтобы подключить его к текущей сессии 小鹈鹕.',
  ...
  'devices.pairModal.instructions':
    'Откройте приложение 小鹈鹕 на iPhone и отсканируйте этот код.',
  ...
  'mcp.connectAuth.oauthHint':
    'Этот сервер использует OAuth. Войдите через браузер, чтобы авторизовать 小鹈鹕.',
  ...
  'autonomy.maxActionsHelp':
    'Максимальное количество действий инструментов, которое агент может выполнить за скользящий час. Новое значение применяется к следующему чату. Задания cron и слушатели каналов сохраняют текущий лимит до перезапуска 小鹈鹕.',
  ...
  'settings.tools.chooseCapabilities':
    'Выбери, какие возможности 小鹈鹕 может использовать от твоего имени.',
  ...
  'voice.providers.chip.cloud': '小鹈鹕 (управляемый)',
  'voice.providers.chip.cloudAria': 'Управляемый провайдер 小鹈鹕 всегда включён',
  ...
  'pttSettings.description':
    'Удерживайте клавишу, чтобы говорить с 小鹈鹕, пока вы находитесь в другом приложении. При отпускании запись отправляется; если включён параметр «Озвучивать ответы», 小鹈鹕 озвучит ответ.',
  ...
  'pttSettings.errorAccessibility':
    'macOS требует разрешения «Универсальный доступ» для этого сочетания. Откройте Системные настройки → Конфиденциальность и безопасность → Универсальный доступ и включите 小鹈鹕.',
  ...
  'pttSettings.errorUnsupportedWayland':
    'Сессии Wayland пока не поддерживают глобальные сочетания клавиш в 小鹈鹕: перейдите на сессию X11 или используйте встроенный переключатель диктовки.',
  ...
  'chat.attachment.videoNotSupported':
    'Эта модель не может читать видео. Вы можете использовать уровень «Рассуждение» от 小鹈鹕, чтобы прикрепить видео.',
  ...
  'chat.attachment.imageNotSupported':
    'Эта модель не может читать изображения. Вы можете использовать уровень «Рассуждение» от 小鹈鹕, чтобы прикрепить изображение.',
  ...
  'bootCheck.desktopDescription':
    '小鹈鹕 нужна среда выполнения для работы. Выбери, где она должна находиться.',
  'bootCheck.webDescription':
    'В браузере 小鹈鹕 подключается к среде выполнения под твоим управлением. Введи URL и токен авторизации, или скачай настольное приложение для локального запуска.',
  ...
  'bootCheck.legacyDescription':
    'На этом устройстве уже запущен отдельно установленный демон 小鹈鹕. Нужно его убрать, прежде чем встроенная среда сможет взять управление.',
  ...
  'bootCheck.portConflictBody':
    'Другой процесс использует сетевой порт, необходимый 小鹈鹕. Попробуем устранить это автоматически.',
  ...
  'bootCheck.portConflictOwner': '{name} (PID {pid}) использует сетевой порт, нужный 小鹈鹕.',
  ...
  'welcome.gatewaySessionErrorFallback':
    'Не удалось завершить вход в систему. Хранилище сеанса не ответило вовремя (даже после повторной попытки). Перезапустите 小鹈鹕 и попробуйте снова.',
  ...
  'composio.expiredDescription':
    'Повторно подключитесь, чтобы повторно включить инструменты {name}. 小鹈鹕 будет держать эту интеграцию недоступной, пока вы не обновите доступ к OAuth.',
  ...
  'mic.voiceNotCompiled':
    'Расшифровка речи не включена в эту версию приложения. Обновите 小鹈鹕, чтобы включить её.',
  ...
  'app.connectionIndicator.connected': 'Подключено к 小鹈鹕 AI 🚀',
  ...
  'app.openhumanLink.notifications.permissionOff':
    'Разрешение на уведомления отключено. Включите 小鹈鹕 в Системных настройках → Уведомления, затем повторите попытку.',
  'app.openhumanLink.notifications.triggerFailed':
    '小鹈鹕 не удалось вызвать системное уведомление. Проверьте настройки уведомлений операционной системы и повторите попытку.',
  'app.openhumanLink.notifications.welcomeBody':
    'Вы будете получать оповещения здесь, когда что-то потребует вашего внимания.',
  'app.openhumanLink.notifications.welcomeTitle': '小鹈鹕 готов к работе',
  ...
  'app.openhumanLink.notifications.sent':
    'Тестовое уведомление отправлено. Если вы его не получили, откройте «Системные настройки» → «Уведомления» → 小鹈鹕, включите «Разрешить уведомления» и установите стиль баннера «Постоянный».',
  ...
  'app.routeLoading.initializing': 'Инициализация 小鹈鹕...',
  ...
  'channels.authMode.managed_dm': 'Войдите с помощью 小鹈鹕',
  ...
  'channels.discord.authMode.oauth.description':
    'Установите бот 小鹈鹕 на свой сервер Discord через OAuth.',
  'channels.discord.authMode.managed_dm.description':
    'Свяжите свою личную учетную запись Discord с ботом 小鹈鹕.',
  ...
  'channels.telegram.authMode.managed_dm.description':
    'Отправьте сообщение боту 小鹈鹕 Telegram напрямую.',
  ...
  'channels.connectHelp.discord':
    'Выберите способ ниже: привяжите аккаунт через 小鹈鹕, установите бота через OAuth или вставьте собственный токен бота из портала разработчика Discord.',
  'channels.connectHelp.telegram':
    'Выберите способ ниже: напишите управляемому боту 小鹈鹕, чтобы привязать его, или вставьте собственный токен бота от @BotFather.',
  ...
  'iosPair.error.invalidQr':
    'Неверный QR-код. Убедитесь, что вы сканируете код сопряжения 小鹈鹕.',
  ...
  'iosPair.instructions':
    'Откройте 小鹈鹕 на рабочем столе, перейдите в Настройки > Устройства и нажмите «Привязать телефон», чтобы показать QR-код.',
  'iosPair.retryScan': 'Повторить сканирование',
  'iosPair.scanQrCode': 'Сканирование QR code',
  'iosPair.scannerOpening': 'Открытие сканера...',
  'iosPair.step.openDesktop': 'Откройте 小鹈鹕 на рабочем столе',
  ...
  'composio.connect.permissionsNoteSuffix':
    'Собственные права агента 小鹈鹕 настраиваются ниже переключателями чтения, записи и администратора.',
  ...
  'composio.triggers.sessionExpired':
    'Срок действия сессии 小鹈鹕 истёк. Войдите снова, чтобы загрузить триггеры.',
  ...
  'daemon.serviceBlockingGate.title': 'Ядро 小鹈鹕 недоступно',
  ...
  'intelligence.diagram.imageAlt': 'Последняя сгенерированная архитектурная диаграмма 小鹈鹕',
  ...
  'flows.nodeSummary.toolCall.pickNative': 'Запускает инструмент 小鹈鹕 (выберите один)',
  ...
  'rewards.community.activityStreakHint': 'Дней подряд с активностью в 小鹈鹕.',
  ...
  'rewards.community.roleClaimDesc':
    'Вы разблокировали роли Discord, но ещё не присоединились к серверу 小鹈鹕. Присоединитесь, чтобы они назначились автоматически.',
  ...
  'settings.ai.providers.managedDetail': '小鹈鹕 выбирает модель для каждой задачи',
  ...
  'settings.ai.openhumanDefault': '小鹈鹕 (по умолчанию)',
  ...
  'settings.ai.managedSourceLabel': 'Управляется 小鹈鹕',
  ...
  'settings.ai.routing.managedDesc':
    '小鹈鹕 выполнит все логические выводы в облаке, выберет лучшую модель для задачи, оптимизирует затраты и сохранит самые безопасные настройки маршрутизации по умолчанию.',
  'settings.ai.routing.managedMsg':
    '小鹈鹕 будет обрабатывать все выводы для каждой рабочей нагрузки и автоматически выбирать лучший маршрут с точки зрения стоимости, качества и безопасности.',
  ...
  'settings.composio.confirmWarning':
    'Ваши существующие интеграции (Gmail, Slack, GitHub и т. д., привязанные через 小鹈鹕) не будут видны: они находятся в управляемом 小鹈鹕 тенанте Composio.',
  ...
  'settings.composio.modeManaged': 'Управляемый (小鹈鹕 управляет за тебя)',
  'settings.composio.modeManagedDesc':
    '小鹈鹕 проксирует вызовы инструментов через наш бэкенд (рекомендуется). Авторизация брокеруется; вам не нужно вставлять API-ключ Composio. Вебхуки полностью маршрутизируются.',
  ...
  'settings.developerMenu.tools.desc':
    'Включайте или отключайте возможности, которые 小鹈鹕 может использовать от вашего имени',
  ...
  'settings.developerMenu.mcpServer.desc':
    'Настройка внешних клиентов MCP для подключения к серверу 小鹈鹕',
  ...
  'settings.mcpServer.binaryPathNotFound':
    'Двоичный файл 小鹈鹕 не найден. При запуске из исходного кода выполните сборку с помощью: Cargo build --bin openhuman-core',
  ...
  'settings.agentAccess.tinyplaceAutopilot.desc':
    'Позвольте 小鹈鹕 самостоятельно действовать в tiny.place. По расписанию он ищет подходящую работу (сначала открытые награды), выполняет задачи по своим навыкам и действует от вашего имени. Он работает без присмотра и может тратить средства, поэтому при тестировании используйте devnet. По умолчанию выключено.',
  ...
  'settings.mascot.colorAria': '小鹈鹕 цвет',
  ...
  'settings.mascot.libraryUnavailable': '小鹈鹕 библиотека недоступна',
  'settings.mascot.title': '小鹈鹕',
  'settings.mascot.loadingLibrary': 'Загрузка библиотеки 小鹈鹕…',
  ...
  'settings.mascot.localDefault': 'Локальный 小鹈鹕 (по умолчанию)',
  'settings.mascot.menuTitle': 'Маскот',
  'settings.mascot.menuDesc': 'Выберите цвет маскота, используемый во всем приложении',
  'settings.mascot.noCharacters': 'Персонажи 小鹈鹕 пока недоступны',
  ...
  'settings.memoryWindow.description':
    'Сколько запомненного контекста 小鹈鹕 добавляет в каждый новый запуск агента. Более широкие окна дают ощущение лучшей памяти о прошлых разговорах, но используют больше токенов (и стоят дороже) на каждом запуске.',
  ...
  'skills.meetingBots.busyTitle': '小鹈鹕 занят',
  'skills.meetingBots.comingSoon': 'Скоро',
  'skills.meetingBots.couldNotLeaveTitle': 'Не удалось покинуть встречу',
  'skills.meetingBots.couldNotStartTitle': 'Не удалось запустить 小鹈鹕',
  'skills.meetingBots.displayName': 'Отображаемое имя',
  'skills.meetingBots.failedToStart': 'Не удалось запустить 小鹈鹕.',
  'skills.meetingBots.joiningMessage': 'Он должен появиться как участник через несколько секунд.',
  'skills.meetingBots.joiningTitle': '小鹈鹕 подключается к встрече',
  'skills.meetingBots.meetingLink': 'Ссылка на встречу',
  'skills.meetingBots.modalAriaLabel': 'Отправить 小鹈鹕 на встречу',
  'skills.meetingBots.modalDesc': 'Описание окна',
  'skills.meetingBots.modalTitle': 'Отправить 小鹈鹕 на встречу',
  ...
  'skills.meetingBots.serverOverloaded':
    '小鹈鹕 сейчас сильно загружен. Пожалуйста, повторите попытку через несколько минут.',
  ...
  'skills.meetingBots.history.runWith小鹈鹕': 'Запустить с 小鹈鹕',
  ...
  'skills.meetingBots.defaults.watchCalendarDesc':
    'Разрешите 小鹈鹕 отслеживать подключённый календарь, чтобы автоматически входить на встречи или запрашивать подтверждение в соответствии с приведёнными ниже политиками. Это не зависит от уведомлений-напоминаний о встречах.',
  ...
  'walkthrough.steps.brainTab.content':
    'Brain: это граф памяти: здесь можно увидеть, что знает 小鹈鹕 и как связаны идеи.',
  ...
  'settings.mascot.noCharactersAvailable': 'Персонажи 小鹈鹕 пока недоступны',
  ...
  'devOptions.menuToolsDesc':
    'Включение или отключение возможностей, которые 小鹈鹕 может использовать от вашего имени',
  ...
  'harnessInit.subtitle': '小鹈鹕 готовит компоненты, необходимые при первом запуске.',
  ...
  'harnessInit.failedMessage':
    'Некоторые шаги настройки не завершились. Вы можете повторить попытку или продолжить: 小鹈鹕 использует встроенный резервный вариант.',
  ...
  'harnessInit.backgroundHint':
    'Вы можете продолжать пользоваться 小鹈鹕, пока это завершается.',

  'keyring.consent.title': 'Безопасное хранилище недоступно',
  'keyring.consent.description':
    'Связка ключей вашей операционной системы недоступна. 小鹈鹕 необходимо ваше разрешение на хранение секретов в локальном зашифрованном хранилище.',
  ...
  'memory.health.remediation.auth_missing':
    'Учётные данные для эмбеддингов не найдены. Войдите в 小鹈鹕 или настройте локальные эмбеддинги Ollama в разделе Подключения → API-ключи → Эмбеддинги.',
  ...
  'memory.health.remediation.storage_unavailable':
    '小鹈鹕 не может записывать в хранилище памяти: диск или SD-карта, похоже, неисправны, заполнены или доступны только для чтения. Проверьте накопитель и освободите место; обработка памяти возобновится автоматически, как только запись снова станет возможной.',
  ...
  'onboarding.custom.vault.defaultDesc':
    'Использовать настройки памяти по умолчанию, управляемые 小鹈鹕. Путь к хранилищу и состояние синхронизации можно проверить позже.',
  ...
  'onboarding.custom.vault.localDisabledReason':
    'Управляемая настройка требует входа в 小鹈鹕 и недоступна в локальном режиме.',
  ...
  'vaultHealth.writableLabel': 'Хранилище доступно для записи 小鹈鹕',
  'vaultHealth.writableRecovery':
    '小鹈鹕 пока не может записывать в это хранилище. Предоставьте права на запись и обновите страницу.',
  ...
  'memoryData.workspaceVaultDesc':
    '小鹈鹕 записывает сгенерированные заметки памяти в memory_tree/content.',
  ...
  'memoryData.internalFilesDesc':
    'Индексы, состояние очереди и сводки управляются 小鹈鹕 для поддержания исправного восстановления и синхронизации.',
  ...
  'settings.gateway.description':
    'Ядро может работать в контейнере, на другой машине по SSH или в контейнере на другой машине. 小鹈鹕 запускает его, подключается к нему и останавливает, когда вы переключаетесь.',
