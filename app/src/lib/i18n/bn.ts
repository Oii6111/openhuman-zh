...
const messages: TranslationMap = {
  ...
  'share.defaultHeadline': 'দেখুন আমার 小鹈鹕 এজেন্ট এইমাত্র কী করেছে',
  'share.defaultAgentName': 'আমার এজেন্ট',
  'share.defaultCaption': 'দেখুন আমার 小鹈鹕 এজেন্ট এইমাত্র কী করেছে।',
  'share.captionWithHeadline': '{headline}। আমার 小鹈鹕 এজেন্ট দিয়ে তৈরি।',
  ...
  'feedback.welcome.body':
    'আমাদের বলুন কী কাজ করছে, কী নেই, এবং কী 小鹈鹕-কে আরও ভালো করবে। একটি ধারণা পোস্ট করুন, অন্যরা যা প্রস্তাব করে তাতে ভোট দিন, এবং সেরাগুলোকে আমাদের রোডম্যাপের শীর্ষে উঠতে দেখুন।',
  ...
  'rewards.welcome.body':
    'আপনি 小鹈鹕 ব্যবহার এবং অন্যদের আমন্ত্রণ জানানোর সময় পয়েন্ট অর্জন করুন, আপনার স্ট্রিক বজায় রাখুন এবং যা অর্জন করেছেন তা রিডিম করুন। সবকিছু এক জায়গায় ট্র্যাক করুন।',
  ...
  'settings.core.applyRestartNote': 'সংরক্ষণ করলে পুনরায় সংযোগের জন্য 小鹈鹕 পুনরায় চালু হয়।',
  ...
  'conversations.toolFailure.missingPermission.cause': '小鹈鹕-এর এখনও এটি করার অনুমতি নেই।',
  ...
  'conversations.toolFailure.serviceUnavailable.cause':
    '小鹈鹕-এর প্রয়োজনীয় একটি পরিষেবা সাময়িকভাবে অনুপলব্ধ।',
  'conversations.toolFailure.serviceUnavailable.next':
    '小鹈鹕 শীঘ্রই আবার চেষ্টা করবে: কোনো পদক্ষেপের প্রয়োজন নেই।',
  ...
  'conversations.toolFailure.modelConnection.cause': '小鹈鹕 AI মডেলে পৌঁছাতে পারেনি।',
  'conversations.toolFailure.modelConnection.next':
    'আপনার সংযোগ বা মডেল সেটিংস পরীক্ষা করুন; 小鹈鹕 আবার চেষ্টা করবে।',
  ...
  'conversations.toolFailure.timeout.next':
    '小鹈鹕 আবার চেষ্টা করবে, অথবা আপনি নিজে আবার চেষ্টা করতে পারেন।',
  ...
  'conversations.toolFailure.approvalExpired.next':
    'এটি চালাতে আবার বলুন: 小鹈鹕 নিজে থেকে পুনরায় চেষ্টা করবে না।',
  ...
  'orchPage.medulla.tagline': '小鹈鹕-এর অর্কেস্ট্রেশন মডেল',
  'orchPage.medulla.body':
    'Medulla হলো 小鹈鹕-এর নিজস্বভাবে তৈরি LLM, যা একসঙ্গে হাজার হাজার এজেন্ট অর্কেস্ট্রেট করার জন্য প্রকৌশলিত, 10 মিলিয়ন-টোকেন কনটেক্সট উইন্ডো এবং অত্যন্ত কম খরচের অর্কেস্ট্রেশন সহ।',
  ...
  'orchPage.medulla.subscriberTitle': '小鹈鹕 সাবস্ক্রাইবার',
  'orchPage.medulla.subscriberNote':
    'Medulla লাইভ হলে এটি শুধুমাত্র 小鹈鹕 সাবস্ক্রাইবারদের জন্য এক্সক্লুসিভ হবে।',
  ...
  'orchPage.connections.initDesc':
    'আপনার সাথে কাজ করার জন্য একটি নতুন সাব-এজেন্ট চালু করুন। এজেন্ট চ্যাট খুলুন এবং এর ভূমিকা, লক্ষ্য ও ব্যবহার্য টুল বর্ণনা করুন: 小鹈鹕 একটি ডেডিকেটেড ইনস্ট্যান্স তৈরি করে যা আপনি এখান থেকে পরিচালনা করতে পারেন।',
  ...
  'tinyplaceOrchestration.master.preview': 'আপনি এবং 小鹈鹕-এর মধ্যে সরাসরি সমন্বয়।',
  ...
  'tinyplaceOrchestration.composer.placeholder': '小鹈鹕-কে বার্তা দিন…',
  ...
  'welcome.resetErrorFallback':
    'অ্যাপ ডেটা মুছতে পারেনি। 小鹈鹕 বন্ধ করে আবার খুলুন, তারপর আবার চেষ্টা করুন।',
  ...
  'home.statusCoreUnreachable':
    'লোকাল কোর সাইডকার সাড়া দিচ্ছে না। 小鹈鹕 ব্যাকগ্রাউন্ড প্রসেস ক্র্যাশ হয়েছে বা শুরু হয়নি।',
  ...
  'rewards.localUnavailable':
    'লোকাল লগইনে কোনো রিওয়ার্ড, কুপন বা রেফারেল ক্রেডিট মেলে না। রিওয়ার্ড পেতে লগ আউট করে একটি 小鹈鹕 অ্যাকাউন্ট দিয়ে সাইন ইন করুন।',
  ...
  'onboarding.welcome': 'হ্যালো। আমি 小鹈鹕।',
  ...
  'onboarding.finishDesc': 'সব প্রস্তুত! 小鹈鹕 ব্যবহার শুরু করুন।',
  'onboarding.skip': 'এড়িয়ে যান',
  'onboarding.getStarted': 'শুরু করুন',
  'onboarding.runtimeChoice.title': 'আপনি কীভাবে 小鹈鹕 চালাতে চান?',
  ...
  'onboarding.runtimeChoice.cloud.tagline': '小鹈鹕 সব কিছু পরিচালনা করবে।',
  ...
  'onboarding.custom.defaultSubtitle': '小鹈鹕 আপনার হয়ে পরিচালনা করবে।',
  ...
  'onboarding.custom.inference.defaultDesc':
    '小鹈鹕 প্রতিটি ওয়ার্কলোড একটি সেন্সিবল ডিফল্ট মডেলে রুট করে। কোনো কী বা সেটআপ নেই।',
  ...
  'onboarding.custom.voice.defaultDesc':
    '小鹈鹕 ম্যানেজড STT/TTS সহ আসে যা সরাসরি কাজ করে। কিছু সেটআপ করতে হবে না।',
  ...
  'onboarding.custom.oauth.defaultDesc':
    '小鹈鹕 একটি ম্যানেজড Composio ওয়ার্কস্পেস চালায়। পরে প্রতিটি সার্ভিস সংযুক্ত করতে এক ক্লিক।',
  ...
  'onboarding.custom.search.subtitle': '小鹈鹕 আপনার হয়ে কীভাবে ওয়েব সার্চ করে।',
  'onboarding.custom.search.defaultDesc':
    '小鹈鹕 ম্যানেজড সার্চ ব্যাকএন্ড ব্যবহার করে। কোনো কী লাগে না।',
  'onboarding.custom.search.configureDesc':
    'নিজের সার্চ প্রোভাইডার কী আনুন (Tavily, Brave ইত্যাদি)। Settings › Tools-এ কনফিগার করুন।',
  'onboarding.custom.embeddings.title': 'Embeddings',
  'onboarding.custom.embeddings.subtitle':
    '小鹈鹕 কীভাবে সিমান্টিক মেমোরি অনুসন্ধানের জন্য ভেক্টর এম্বেডিং তৈরি করে।',
  'onboarding.custom.embeddings.defaultDesc':
    '小鹈鹕 একটি পরিচালিত এম্বেডিং সেবা ব্যবহার করে। কোনো API কী প্রয়োজন নেই।',
  ...
  'onboarding.custom.memory.subtitle':
    '小鹈鹕 কীভাবে আপনার কন্টেক্সট, পছন্দ ও পূর্ববর্তী কথোপকথন মনে রাখে।',
  'onboarding.custom.memory.defaultDesc':
    '小鹈鹕 স্বয়ংক্রিয়ভাবে মেমোরি স্টোরেজ ও রিট্রিভাল পরিচালনা করে। কিছু সেটআপ করতে হবে না।',
  ...
  'misc.beta':
    '小鹈鹕 এখন আর্লি বেটায় আছে। যেকোনো মতামত বা বাগ রিপোর্ট করুন: প্রতিটি রিপোর্ট আমাদের দ্রুত এগিয়ে যেতে সাহায্য করে।',
  ...
  'privacy.shareAnonymizedDataDesc':
    'গোপনীয়তা-সীমিত ক্র্যাশ রিপোর্ট ও ব্যবহার ইভেন্ট শেয়ার করে 小鹈鹕 উন্নত করতে সাহায্য করুন, যার মধ্যে স্থিতিশীল অ্যাকাউন্ট ID ও অ্যাপ সংস্করণ মেটাডেটা থাকে। বার্তা, ওয়ালেট কী, API কী বা সেশন টোকেন কখনো সংগ্রহ করা হয় না।',
  ...
  'privacy.autoHandoffMeetDesc':
    'Google Meet কল শেষ হলে, 小鹈鹕-এর অর্কেস্ট্রেটর ট্রান্সক্রিপ্ট পড়তে এবং বার্তা ড্রাফট করা, ফলো-আপ নির্ধারণ করা বা সংযুক্ত Slack ওয়ার্কস্পেসে সারসংক্ষেপ পোস্ট করার মতো কাজ করতে পারে। ডিফল্টে বন্ধ।',
  ...
  'settings.about.starCta.title': '小鹈鹕 ভালো লাগছে?',
  ...
  'settings.search.description':
    'এজেন্ট যে সার্চ ইঞ্জিন ব্যবহার করে তা বেছে নিন, অথবা সার্চ টুলগুলো সম্পূর্ণভাবে নিষ্ক্রিয় করুন। Managed 小鹈鹕-এর ব্যাকএন্ড ব্যবহার করে (কোনো সেটআপ নেই)। Parallel, Brave, Querit, এবং Exa আপনার API কী ব্যবহার করে সরাসরি আপনার মেশিন থেকে চলে।',
  ...
  'settings.search.engineManagedLabel': '小鹈鹕 পরিচালিত',
  'settings.search.engineManagedDesc':
    'ডিফল্ট। 小鹈鹕 ব্যাক-এন্ডের মাধ্যমে রুট করা হয়, বর্তমানে Exa দ্বারা চালিত: কোনো API key প্রয়োজন নেই।',
  'settings.search.localManagedUnavailable':
    'লোকাল ব্যবহারকারীদের জন্য 小鹈鹕 Managed সার্চ উপলভ্য নয়। ওয়েব সার্চ চালু করতে আপনার নিজের Parallel, Brave, Querit বা Exa API key যোগ করুন।',
  ...
  'settings.embeddings.requiresSignIn': '小鹈鹕-এ সাইন-ইন প্রয়োজন',
  'settings.embeddings.managedLoginRequired':
    'ম্যানেজড এমবেডিংসের জন্য 小鹈鹕 সাইন-ইন প্রয়োজন। 小鹈鹕 ব্যাকএন্ড ব্যবহার করতে সাইন ইন করুন।',
  'settings.embeddings.managedBannerIntro':
    'ম্যানেজড এমবেডিংস 小鹈鹕 ব্যাকএন্ডের মাধ্যমে চলে এবং একটি 小鹈鹕 অ্যাকাউন্ট সেশন প্রয়োজন।',
  ...
  'settings.embeddings.managedBannerRemoteSession':
    '小鹈鹕 সেশন রিফ্রেশ করতে আবার সাইন ইন করুন, অথবা স্থানীয়/নিজস্ব-কী এমবেডিং প্রোভাইডারে যান।',
  ...
  'devices.betaText':
    'এই ফিচারটি এখন বেটায় আছে। iOS ফোনকে রিমোট ক্লায়েন্ট হিসেবে ব্যবহার করতে এই 小鹈鹕-এর সাথে পেয়ার করুন।',
  ...
  'devices.emptyState': 'এই 小鹈鹕 সেশনে সংযোগ করতে আপনার iPhone এ একটি QR code স্ক্যান করুন।',
  ...
  'devices.pairModal.instructions':
    'আপনার iPhone-এ 小鹈鹕 অ্যাপ খুলুন এবং এই কোডটি স্ক্যান করুন।',
  ...
  'mcp.connectAuth.oauthHint':
    'এই সার্ভারটি OAuth ব্যবহার করে। 小鹈鹕-কে অনুমোদন দিতে আপনার ব্রাউজারের মাধ্যমে সাইন ইন করুন।',
  ...
  'autonomy.maxActionsHelp':
    'একজন এজেন্ট প্রতি ঘণ্টায় সর্বোচ্চ কতটি টুল অ্যাকশন চালাতে পারবে। নতুন মান আপনার পরবর্তী চ্যাটে প্রযোজ্য হবে। Cron জব এবং চ্যানেল লিসেনার 小鹈鹕 পুনরায় চালু না করা পর্যন্ত বর্তমান সীমা বজায় রাখবে।',
  ...
  'settings.tools.chooseCapabilities':
    '小鹈鹕 আপনার হয়ে কোন ক্যাপাবিলিটিগুলো ব্যবহার করতে পারবে তা বেছে নিন।',
  ...
  'voice.providers.chip.cloud': '小鹈鹕 (পরিচালিত)',
  'voice.providers.chip.cloudAria': '小鹈鹕 পরিচালিত প্রোভাইডার সর্বদা সক্রিয়',
  ...
  'pttSettings.description':
    'অন্য একটি অ্যাপে থাকার সময় 小鹈鹕-এর সাথে কথা বলতে একটি কী চেপে ধরে রাখুন। কী ছেড়ে দিলে রেকর্ডিং পাঠানো হয়; «উত্তর পড়ে শোনাও» চালু থাকলে 小鹈鹕 উত্তরটি জোরে পড়ে শোনায়।',
  ...
  'pttSettings.errorAccessibility':
    'এই শর্টকাটের জন্য macOS-এর অ্যাক্সেসিবিলিটি অনুমতি দরকার। System Settings → Privacy & Security → Accessibility খুলুন এবং 小鹈鹕 চালু করুন।',
  ...
  'pttSettings.errorUnsupportedWayland':
    'Wayland সেশন এখনও 小鹈鹕-এ গ্লোবাল শর্টকাট সমর্থন করে না: একটি X11 সেশনে চলে যান অথবা অ্যাপের ভেতরের ডিকটেশন টগল ব্যবহার করুন।',
  ...
  'chat.attachment.videoNotSupported':
    'এই মডেল ভিডিও পড়তে পারে না। আপনার ভিডিও সংযুক্ত করতে আপনি 小鹈鹕 যুক্তি স্তর ব্যবহার করতে পারেন।',
  ...
  'chat.attachment.imageNotSupported':
    'এই মডেলটি ছবি পড়তে পারে না। আপনার ছবি সংযুক্ত করতে আপনি 小鹈鹕 যুক্তি স্তর ব্যবহার করতে পারেন।',
  ...
  'bootCheck.desktopDescription':
    '小鹈鹕 চিন্তা করতে একটি রানটাইম প্রয়োজন। এটি কোথায় থাকবে তা বেছে নিন।',
  'bootCheck.webDescription':
    'ওয়েবে, 小鹈鹕 আপনার নিয়ন্ত্রণে একটি রানটাইমে সংযুক্ত হয়। নিচে এর URL ও অথ টোকেন দিন, অথবা সরাসরি আপনার মেশিনে চালাতে ডেস্কটপ অ্যাপ নিন।',
  ...
  'bootCheck.legacyDescription':
    'এই ডিভাইসে আলাদাভাবে ইনস্টল করা একটি 小鹈鹕 ডেমন ইতিমধ্যে চলছে। বিল্ট-ইন রানটাইম নিয়ন্ত্রণ নেওয়ার আগে এটি সরাতে হবে।',
  ...
  'bootCheck.portConflictBody':
    'অন্য একটি প্রক্রিয়া 小鹈鹕-এর প্রয়োজনীয় নেটওয়ার্ক পোর্ট ব্যবহার করছে। আমরা স্বয়ংক্রিয়ভাবে এটি ঠিক করার চেষ্টা করব।',
  ...
  'bootCheck.portConflictOwner':
    '{name} (PID {pid}) 小鹈鹕-এর প্রয়োজনীয় নেটওয়ার্ক পোর্টটি ব্যবহার করছে।',
  ...
  'welcome.gatewaySessionErrorFallback':
    'এই মুহূর্তে সাইন-ইন সম্পূর্ণ করা যায়নি। সেশন স্টোর সময়মতো সাড়া দেয়নি (বারবার চেষ্টা করেও)। অনুগ্রহ করে 小鹈鹕 পুনরায় চালু করুন এবং আবার চেষ্টা করুন।',
  ...
  'composio.expiredDescription':
    'পুনরায় সংযোগ করতে PH__0 টুল পুনরায় সংযুক্ত করুন। আপনি OAuth অ্যাক্সেস রিফ্রেশ না করা পর্যন্ত 小鹈鹕 এই ইন্টিগ্রেশনটি অনুপলব্ধ রাখবে৷',
  ...
  'mic.voiceNotCompiled':
    'অ্যাপের এই সংস্করণে ভয়েস ট্রান্সক্রিপশন অন্তর্ভুক্ত নেই। এটি চালু করতে 小鹈鹕 আপডেট করুন।',
  ...
  'app.connectionIndicator.connected': '小鹈鹕 AI-এ সংযুক্ত 🚀',
  ...
  'app.openhumanLink.notifications.permissionOff':
    'বিজ্ঞপ্তির অনুমতি বন্ধ আছে। সিস্টেম সেটিংস → বিজ্ঞপ্তি-তে 小鹈鹕 সক্রিয় করুন, তারপর পুনরায় চেষ্টা করুন।',
  'app.openhumanLink.notifications.triggerFailed':
    '小鹈鹕 একটি সিস্টেম বিজ্ঞপ্তি চালু করতে পারেনি। OS-এর বিজ্ঞপ্তি সেটিংস যাচাই করুন এবং পুনরায় চেষ্টা করুন।',
  'app.openhumanLink.notifications.welcomeBody':
    'যখন কোনো কিছুতে আপনার মনোযোগ প্রয়োজন হবে, তখন আপনি এখানে পিং পাবেন।',
  'app.openhumanLink.notifications.welcomeTitle': '小鹈鹕 ব্যবহারের জন্য প্রস্তুত',
  ...
  'app.openhumanLink.notifications.sent':
    'টেস্ট নোটিফিকেশন পাঠানো হয়েছে। যদি না পেয়ে থাকেন, System Settings → Notifications → 小鹈鹕-এ যান, Allow Notifications চালু করুন, এবং Banner Style-কে Persistent-এ সেট করুন।',
  ...
  'app.routeLoading.initializing': '小鹈鹕 শুরু হচ্ছে...',
  ...
  'channels.authMode.managed_dm': '小鹈鹕 দিয়ে লগইন করুন',
  ...
  'channels.discord.authMode.oauth.description':
    'OAuth এর মাধ্যমে আপনার Discord সার্ভারে 小鹈鹕 বট ইনস্টল করুন।',
  'channels.discord.authMode.managed_dm.description':
    'আপনার ব্যক্তিগত Discord অ্যাকাউন্টটি 小鹈鹕 বটের সাথে লিঙ্ক করুন।',
  ...
  'channels.telegram.authMode.managed_dm.description': 'সরাসরি 小鹈鹕 Telegram বটকে মেসেজ করুন।',
  ...
  'channels.connectHelp.discord':
    'নিচে একটি পদ্ধতি বেছে নিন: 小鹈鹕-এর মাধ্যমে আপনার অ্যাকাউন্ট লিঙ্ক করুন, OAuth দিয়ে বট ইনস্টল করুন, অথবা Discord ডেভেলপার পোর্টাল থেকে আপনার নিজের বট টোকেন পেস্ট করুন।',
  'channels.connectHelp.telegram':
    'নিচে একটি পদ্ধতি বেছে নিন: লিঙ্ক করতে ম্যানেজড 小鹈鹕 বটে বার্তা পাঠান, অথবা @BotFather থেকে আপনার নিজের বট টোকেন পেস্ট করুন।',
  ...
  'iosPair.error.invalidQr':
    'অবৈধ QR কোড। নিশ্চিত করুন আপনি একটি 小鹈鹕 পেয়ারিং কোড স্ক্যান করছেন।',
  ...
  'iosPair.instructions':
    'আপনার ডেস্কটপে 小鹈鹕 খুলুন, Settings > Devices-এ যান, এবং QR কোড দেখাতে "Pair phone" ট্যাপ করুন।',
  ...
  'iosPair.step.openDesktop': 'ডেস্কটপে 小鹈鹕 খুলুন',
  ...
  'composio.connect.permissionsNoteSuffix':
    '小鹈鹕-এর নিজস্ব এজেন্ট অনুমতি নিচে read, write, এবং admin টগল হিসেবে নিয়ন্ত্রিত।',
  ...
  'composio.triggers.sessionExpired':
    'আপনার 小鹈鹕 সেশনের মেয়াদ শেষ হয়েছে। ট্রিগার লোড করতে আবার সাইন ইন করুন।',
  ...
  'daemon.serviceBlockingGate.title': '小鹈鹕 কোর পাওয়া যাচ্ছে না',
  ...
  'intelligence.diagram.imageAlt': 'সর্বশেষ তৈরি 小鹈鹕 আর্কিটেকচার ডায়াগ্রাম',
  ...
  'flows.nodeSummary.toolCall.pickNative': 'একটি 小鹈鹕 টুল চালায় (একটি বেছে নিন)',
  ...
  'rewards.community.activityStreakHint': '小鹈鹕-এ পরপর সক্রিয় থাকার দিন।',
  ...
  'rewards.community.roleClaimDesc':
    'আপনি Discord রোল আনলক করেছেন কিন্তু এখনও 小鹈鹕 সার্ভারে যোগ দেননি। যোগ দিন যাতে সেগুলি স্বয়ংক্রিয়ভাবে বরাদ্দ হয়।',
  ...
  'settings.ai.providers.managedDetail': '小鹈鹕 প্রতিটি কাজের জন্য মডেল বেছে নেয়',
  ...
  'settings.ai.openhumanDefault': '小鹈鹕 (ডিফল্ট)',
  ...
  'settings.ai.managedSourceLabel': '小鹈鹕 দ্বারা পরিচালিত',
  ...
  'settings.composio.confirmWarning':
    '小鹈鹕-এর মাধ্যমে লিঙ্ক করা আপনার বিদ্যমান ইন্টিগ্রেশনগুলি (Gmail, Slack, GitHub ইত্যাদি) দৃশ্যমান হবে না: সেগুলি 小鹈鹕-পরিচালিত Composio টেন্যান্টে থাকে।',
  ...
  'settings.composio.modeManaged': 'ম্যানেজড (小鹈鹕 আপনার হয়ে পরিচালনা করে)',
  'settings.composio.modeManagedDesc':
    '小鹈鹕 আমাদের ব্যাকএন্ডের মাধ্যমে টুল কল প্রক্সি করে (প্রস্তাবিত)। অথ ব্রোকার করা হয়; আপনি কখনও Composio API key পেস্ট করেন না। Webhooks সম্পূর্ণরূপে রুট করা।',
  ...
  'settings.developerMenu.tools.desc':
    '小鹈鹕 আপনার পক্ষ থেকে যে সক্ষমতাগুলি ব্যবহার করতে পারে সেগুলি চালু বা বন্ধ করুন',
  ...
  'settings.developerMenu.mcpServer.desc':
    'বাহ্যিক MCP ক্লায়েন্টগুলিকে 小鹈鹕-এ সংযুক্ত করতে কনফিগার করুন',
  ...
  'settings.mcpServer.binaryPathNotFound':
    '小鹈鹕 বাইনারি পাওয়া যায়নি। উৎস থেকে চললে, এর সাথে তৈরি করুন: cargo build --bin openhuman-core',
  ...
  'settings.agentAccess.tinyplaceAutopilot.desc':
    '小鹈鹕-কে tiny.place-এ নিজে কাজ করতে দিন। এটি নির্ধারিত সময় অনুযায়ী মূল্যবান কাজ খোঁজে (প্রথমে খোলা বাউন্টি), নিজের দক্ষতার সাথে মানানসই কাজ করে এবং আপনার পরিচয় থেকে কাজ করে। এটি তত্ত্বাবধান ছাড়াই চলে এবং অর্থ ব্যয় করতে পারে, তাই পরীক্ষার সময় এটি devnet-এ রাখুন। ডিফল্টভাবে বন্ধ।',
  ...
  'settings.mascot.colorAria': '小鹈鹕 রঙ',
  ...
  'settings.memoryWindow.description':
    'প্রতিটি নতুন এজেন্ট রানে 小鹈鹕 কতটা মনে রাখা প্রসঙ্গ ইনজেক্ট করে। বড় উইন্ডো অতীত কথোপকথন সম্পর্কে বেশি সচেতন মনে হয় কিন্তু প্রতিটি রানে বেশি টোকেন ব্যবহার করে, এবং বেশি খরচ হয়।',
  ...
  'skills.meetingBots.busyTitle': '小鹈鹕 ব্যস্ত',
  'skills.meetingBots.comingSoon': 'শীঘ্রই আসছে',
  'skills.meetingBots.couldNotLeaveTitle': 'মিটিং থেকে বেরোনো যায়নি',
  'skills.meetingBots.couldNotStartTitle': '小鹈鹕 শুরু করা যায়নি',
  'skills.meetingBots.displayName': 'প্রদর্শন নাম',
  'skills.meetingBots.failedToStart': '小鹈鹕 শুরু করতে ব্যর্থ।',
  'skills.meetingBots.joiningMessage': 'কয়েক সেকেন্ডের মধ্যে অংশগ্রহণকারী হিসেবে দেখা যাবে।',
  'skills.meetingBots.joiningTitle': '小鹈鹕 মিটিংয়ে যোগ দিচ্ছে',
  'skills.meetingBots.meetingLink': 'মিটিং লিংক',
  'skills.meetingBots.modalAriaLabel': '小鹈鹕-কে একটি মিটিংয়ে পাঠান',
  'skills.meetingBots.modalDesc': 'মোডাল বিবরণ',
  'skills.meetingBots.modalTitle': '小鹈鹕-কে একটি মিটিংয়ে পাঠান',
  ...
  'skills.meetingBots.serverOverloaded':
    '小鹈鹕 এই মুহূর্তে অত্যধিক চাপের মধ্যে রয়েছে। অনুগ্রহ করে কয়েক মিনিট পরে আবার চেষ্টা করুন।',
  ...
  'skills.meetingBots.history.runWith小鹈鹕': '小鹈鹕 দিয়ে চালান',
  ...
  'skills.meetingBots.defaults.watchCalendarDesc':
    '小鹈鹕-কে আপনার সংযুক্ত ক্যালেন্ডার দেখতে দিন যাতে এটি নীচের নীতিগুলির উপর ভিত্তি করে মিটিংয়ে স্বয়ংক্রিয়ভাবে যোগ দিতে বা অনুরোধ করতে পারে। এটি মিটিং অনুস্মারক বিজ্ঞপ্তি থেকে আলাদা।',
  ...
  'walkthrough.steps.brainTab.content':
    'Brain হলো মেমোরি গ্রাফ: 小鹈鹕 কী জানে এবং ধারণাগুলো কীভাবে যুক্ত তা দেখার জায়গা।',
  ...
  'settings.mascot.noCharactersAvailable': 'কোনো 小鹈鹕 ক্যারেক্টার এখনও উপলব্ধ নেই',
  ...
  'harnessInit.subtitle': 'প্রথম চালুর সময় 小鹈鹕 প্রয়োজনীয় উপাদানগুলো প্রস্তুত করছে।',
  ...
  'harnessInit.failedMessage':
    'কিছু সেটআপ ধাপ সম্পন্ন হয়নি। আপনি পুনরায় চেষ্টা করতে পারেন, অথবা চালিয়ে যেতে পারেন: 小鹈鹕 একটি অন্তর্নির্মিত ফলব্যাক ব্যবহার করবে।',
  ...
  'harnessInit.backgroundHint':
    'এটি শেষ হওয়া পর্যন্ত আপনি 小鹈鹕 ব্যবহার করা চালিয়ে যেতে পারেন।',

  'keyring.consent.title': 'নিরাপদ সঞ্চয়স্থান অনুপলব্ধ',
  'keyring.consent.description':
    'আপনার অপারেটিং সিস্টেমের কিচেন অ্যাক্সেসযোগ্য নয়। 小鹈鹕-এর পরিবর্তে স্থানীয় এনক্রিপ্টেড সঞ্চয়স্থান ব্যবহার করে গোপনীয়তা সংরক্ষণ করতে আপনার অনুমতি প্রয়োজন।',
  ...
  'memory.health.remediation.auth_missing':
    'কোনও এমবেডিং শংসাপত্র পাওয়া যায়নি। 小鹈鹕-এ লগ ইন করুন, অথবা সংযোগ → API কী → এমবেডিংস-এ স্থানীয় Ollama এমবেডিং সেট আপ করুন।',
  ...
  'memory.health.remediation.storage_unavailable':
    '小鹈鹕 তার মেমরি স্টোরেজে লিখতে পারছে না: ডিস্ক বা SD কার্ডটি ত্রুটিপূর্ণ, পূর্ণ বা শুধু-পঠনযোগ্য বলে মনে হচ্ছে। ড্রাইভটি পরীক্ষা করুন এবং কিছু জায়গা খালি করুন; স্টোরেজ আবার লেখার উপযোগী হলে মেমরি প্রক্রিয়াকরণ স্বয়ংক্রিয়ভাবে পুনরায় শুরু হবে।',
  ...
  'onboarding.custom.vault.defaultDesc':
    '小鹈鹕-পরিচালিত মেমোরির ডিফল্ট ব্যবহার করুন। ভল্ট পাথ এবং সিঙ্ক স্বাস্থ্য পরে পর্যালোচনা করা যাবে।',
  ...
  'onboarding.custom.vault.localDisabledReason':
    'পরিচালিত সেটআপের জন্য 小鹈鹕 সাইন-ইন প্রয়োজন এবং লোকাল মোডে উপলব্ধ নয়।',
  ...
  'vaultHealth.writableLabel': 'ভল্ট 小鹈鹕 দ্বারা লিখনযোগ্য',
  'vaultHealth.writableRecovery':
    '小鹈鹕 এখনও এই ভল্টে লিখতে পারছে না। লেখার অনুমতি দিন এবং রিফ্রেশ করুন।',
  ...
  'memoryData.workspaceVaultDesc': '小鹈鹕 তৈরি মেমোরি নোট memory_tree/content-এ লেখে।',
  ...
  'memoryData.internalFilesDesc':
    'ইন্ডেক্স, কিউ স্টেট এবং সারসংক্ষেপ 小鹈鹕 দ্বারা পরিচালিত হয় যাতে রিকল ও সিঙ্ক সুস্থ থাকে।',
  ...
  'settings.gateway.description':
    'কোর একটি কনটেইনারে, SSH দিয়ে অন্য একটি মেশিনে, বা অন্য মেশিনের কনটেইনারে চলতে পারে। 小鹈鹕 সেটি চালু করে, সংযোগ করে, এবং আপনি অন্য কোথাও গেলে বন্ধ করে দেয়।',
